...
`,Fc="workbench-icon-sprite-host";let to=null,io="",Pc=!1;function Db(){return to||(to=Object.assign({"./svg/apply-transform.svg":C_,"./svg/camera-dslr.svg":F_,"./svg/camera-frames.svg":P_,"./svg/camera-property.svg":R_,"./svg/camera.svg":I_,"./svg/chevron-left.svg":D_,"./svg/chevron-right.svg":L_,"./svg/clock.svg":N_,"./svg/close.svg":z_,"./svg/copy-to-camera.svg":B_,"./svg/copy-to-viewport.svg":O_,"./svg/cursor.svg":j_,"./svg/duplicate.svg":V_,"./svg/export-tab.svg":U_,"./svg/export.svg":H_,"./svg/eye-off.svg":G_,"./svg/eye.svg":W_,"./svg/folder-open.svg":X_,"./svg/frame-plus.svg":Y_,"./svg/frame.svg":q_,"./svg/grip.svg":Z_,"./svg/help.svg":J_,"./svg/image.svg":K_,"./svg/lens.svg":Q_,"./svg/light.svg":eb,"./svg/link.svg":tb,"./svg/lock-open.svg":ib,"./svg/lock.svg":nb,"./svg/mask-all.svg":rb,"./svg/mask-selected.svg":sb,"./svg/mask.svg":ob,"./svg/menu.svg":ab,"./svg/move.svg":lb,"./svg/package-open.svg":cb,"./svg/package.svg":hb,"./svg/pie-menu.svg":ub,"./svg/pin.svg":db,"./svg/pivot.svg":pb,"./svg/plus.svg":mb,"./svg/redo.svg":fb,"./svg/reference-preview-off.svg":gb,"./svg/reference-preview-on.svg":yb,"./svg/reference-tool.svg":_b,"./svg/reference.svg":bb,"./svg/render-box.svg":xb,"./svg/reset.svg":vb,"./svg/ruler.svg":wb,"./svg/save.svg":Mb,"./svg/scene.svg":Sb,"./svg/scrub.svg":$b,"./svg/selection-clear.svg":kb,"./svg/settings.svg":Eb,"./svg/slash-circle.svg":Tb,"./svg/splat-edit.svg":Ab,"./svg/trash.svg":Cb,"./svg/undo.svg":Fb,"./svg/view.svg":Pb,"./svg/viewport.svg":Rb,"./svg/zoom.svg":Ib})),to}function Bo(i){return String(i).replaceAll("&","&amp;").replaceAll('"',"&quot;").replaceAll("<","&lt;").replaceAll(">","&gt;")}function Lb(i){const e=i.match(/\/([^/]+)\.svg$/i);return e?e[1]:null}function Nb(i=""){var r;let e=i.replace(/\s+xmlns(?::[\w-]+)?=(["']).*?\1/gi,"").replace(/\s+width=(["']).*?\1/gi,"").replace(/\s+height=(["']).*?\1/gi,"").replace(/\s+viewBox=(["']).*?\1/gi,"").replace(/\s+aria-hidden=(["']).*?\1/gi,"").replace(/\s+focusable=(["']).*?\1/gi,"");const t=e.match(/\sstroke-width=(["'])(.*?)\1/i),n=((r=t==null?void 0:t[2])==null?void 0:r.trim())||"1.8";return e=e.replace(/\sstroke-width=(["']).*?\1/gi,` stroke-width="var(--workbench-icon-stroke-width, ${Bo(n)})"`),/\sfill=/i.test(e)||(e+=' fill="none"'),/\sstroke=/i.test(e)||(e+=' stroke="currentColor"'),/\sstroke-width=/i.test(e)||(e+=' stroke-width="var(--workbench-icon-stroke-width, 1.8)"'),/\sstroke-linecap=/i.test(e)||(e+=' stroke-linecap="round"'),/\sstroke-linejoin=/i.test(e)||(e+=' stroke-linejoin="round"'),e.trim()}function zb(i,e){const t=e.match(/<svg\b([^>]*)>([\s\S]*?)<\/svg>/i);if(!t)return"";const[,n,r]=t,s=n.match(/\sviewBox=(["'])(.*?)\1/i),o=(s==null?void 0:s[2])||"0 0 24 24",a=Nb(n);return`<symbol id="${Bo(i)}" viewBox="${Bo(o)}"${a?` ${a}`:""}>${r.trim()}</symbol>`}function Bb(){return`<svg xmlns="http://www.w3.org/2000/svg">${Object.entries(Db()).map(([e,t])=>[Lb(e),t]).filter(([e,t])=>!!e&&typeof t=="string").map(([e,t])=>zb(e,t)).filter(Boolean).join("")}</svg>`}function Ob(){if(Pc||typeof document>"u")return;io||(io=Bb());let i=document.getElementById(Fc);i||(i=document.createElement("div"),i.id=Fc,i.setAttribute("aria-hidden","true"),i.style.position="absolute",i.style.width="0",i.style.height="0",i.style.overflow="hidden",i.style.pointerEvents="none",i.style.opacity="0",i.innerHTML=io,document.body.prepend(i)),Pc=!0}function be({name:i,className:e="",size:t=16,strokeWidth:n=1.8}){Ob();const r=["workbench-icon"];return e&&r.push(e),v`
	...
	`}function Vo({controller:i,historyLabel:e,onLiveChange:t,...n}){const[r,s]=ye(!1);function o(l){var u,h;W(l),!r&&((h=(u=i==null?void 0:i())==null?void 0:u.beginHistoryTransaction)==null||h.call(u,e),s(!0))}function a(){var l,u;r&&((u=(l=i==null?void 0:i())==null?void 0:l.commitHistoryTransaction)==null||u.call(l,e),s(!1))}function c(){var l,u;r&&((u=(l=i==null?void 0:i())==null?void 0:l.cancelHistoryTransaction)==null||u.call(l),s(!1))}return v`
		<input
			...
			onWheel=${Rn}
		/>
	`}function Uo(i,e,{snap:t=!1}={}){const n=Number(e);if(!Number.isFinite(n))return;const r=t?oy(n):la(n);i==null||i(ca(r))}const wr="scene",Mr="camera",Sr="reference",Ho="export",xx="scene-main",vx="scene-transform",wx="shot-camera",Mx="shot-camera-properties",Sx="lighting",$x="output-frame",kx="reference-presets",Ex="reference-manager",Tx="reference-properties",Ax="export-output",Cx="export-settings";function ld(i){return[{id:wr,label:i("section.scene"),icon:"scene",tooltip:{title:i("section.scene"),description:i("tooltip.tabScene"),placement:"bottom"}},{id:Mr,label:i("section.shotCamera"),icon:"camera-dslr",tooltip:{title:i("section.shotCamera"),description:i("tooltip.tabCamera"),placement:"bottom"}},{id:Sr,label:i("section.referenceImages"),icon:"image",tooltip:{title:i("section.referenceImages"),description:i("tooltip.tabReference"),placement:"bottom"}},{id:Ho,label:i("section.export"),icon:"export-tab",tooltip:{title:i("section.export"),description:i("tooltip.tabExport"),placement:"bottom"}}]}function vM(i){return[{id:xx,tabId:wr,label:i("section.sceneManager"),icon:"scene"},{id:wx,tabId:Mr,label:i("section.shotCameraManager"),icon:"camera"},{id:Mx,tabId:Mr,label:i("section.shotCameraProperties"),icon:"camera-property"},{id:Sx,tabId:wr,label:i("section.lighting"),icon:"light"},{id:vx,tabId:wr,label:i("section.selectedSceneObject"),icon:"move"},{id:$x,tabId:Mr,label:i("section.outputFrame"),icon:"render-box"},{id:kx,tabId:Sr,label:i("section.referencePresets"),icon:"image"},{id:Ex,tabId:Sr,label:i("section.referenceManager"),icon:"reference-tool"},{id:Tx,tabId:Sr,label:i("section.referenceProperties"),icon:"reference-tool"},{id:Ax,tabId:Ho,label:i("section.output"),icon:"export-tab"},{id:Cx,tabId:Ho,label:i("section.exportSettings"),icon:"export-tab"}]}function Fx({activeShotCamera:i,controller:e,shotCameras:t,t:n}){const r=t.length>1&&!!i;return v`
	...
	`}function RM({activeTab:i,setActiveTab:e,t}){const n=ld(t);return v`
		<${ex}
			...
			iconOnly=${!0}
		/>
	`}const Yc=15,Dx={right:0,"top-right":135,top:90,"top-left":45,left:0,"bottom-left":135,bottom:90,"bottom-right":45},so=new Map;function Lx(i){const e=Number.isFinite(i)?i%360:0;return e<0?e+360:e}function Nx(i){return Math.round(Lx(i)/Yc)*Yc}function zx(i){return`
		<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
			<g transform="rotate(${i} 16 16)" fill="none" stroke-linecap="round" stroke-linejoin="round">
	...
	`}export{Rv as $,Q1 as A,Ph as B,$m as C,pv as D,Tn as E,wg as F,o1 as G,Cm as H,Dh as I,L1 as J,pn as K,_l as L,es as M,Hv as N,Og as O,_t as P,Nh as Q,Qo as R,jh as S,hl as T,Ko as U,k as V,zh as W,bv as X,_v as Y,al as Z,Iv as _,Kv as a,Km as a$,Pv as a0,Fv as a1,Ev as a2,Av as a3,cl as a4,$v as a5,kv as a6,Tv as a7,Cv as a8,ll as a9,Pm as aA,N1 as aB,qh as aC,Rm as aD,Im as aE,km as aF,Em as aG,Am as aH,Qr as aI,Dm as aJ,Lm as aK,Lh as aL,zm as aM,Bm as aN,Om as aO,jm as aP,Vm as aQ,Um as aR,Hm as aS,Gm as aT,_s as aU,Wm as aV,Xm as aW,Ym as aX,qm as aY,Zm as aZ,Jm as a_,Sv as aa,Mv as ab,wv as ac,pl as ad,Mi as ae,dl as af,r1 as ag,n1 as ah,i1 as ai,Ot as aj,y1 as ak,g1 as al,_1 as am,m1 as an,f1 as ao,p1 as ap,b1 as aq,d1 as ar,bi as as,j1 as at,h1 as au,V1 as av,hv as aw,dv as ax,Tm as ay,Fm as az,we as b,Pe as b$,Qm as b0,ef as b1,tf as b2,nf as b3,rf as b4,sf as b5,of as b6,af as b7,lf as b8,cf as b9,Qv as bA,e1 as bB,T1 as bC,Wf as bD,E1 as bE,Mf as bF,u1 as bG,k1 as bH,ts as bI,St as bJ,sw as bK,bl as bL,rg as bM,ng as bN,Of as bO,v1 as bP,Bh as bQ,uv as bR,qv as bS,Jv as bT,Zv as bU,Yv as bV,Xv as bW,Wv as bX,Gv as bY,dg as bZ,$1 as b_,hf as ba,uf as bb,df as bc,pf as bd,mf as be,ff as bf,gf as bg,yf as bh,_f as bi,bf as bj,xf as bk,jv as bl,Ov as bm,Bv as bn,zv as bo,Nv as bp,Lv as bq,Dv as br,av as bs,lv as bt,cv as bu,ol as bv,yv as bw,gv as bx,fv as by,mv as bz,tg as c,Ta as c$,Dr as c0,Uv as c1,Vv as c2,Mm as c3,xv as c4,vv as c5,a1 as c6,c1 as c7,l1 as c8,Cn as c9,U1 as cA,gg as cB,Ir as cC,fo as cD,Lr as cE,Or as cF,Br as cG,ns as cH,is as cI,jt as cJ,Tt as cK,Aa as cL,Ve as cM,Fn as cN,We as cO,ct as cP,aw as cQ,tu as cR,eu as cS,uc as cT,Qh as cU,Ru as cV,s0 as cW,xo as cX,bo as cY,Du as cZ,Gr as c_,Z1 as ca,H1 as cb,O1 as cc,W1 as cd,X1 as ce,Y1 as cf,R1 as cg,Jt as ch,Yl as ci,pe as cj,G1 as ck,K1 as cl,Vh as cm,Sg as cn,Vt as co,Wh as cp,$g as cq,le as cr,P1 as cs,Mg as ct,Xh as cu,I1 as cv,D1 as cw,Qn as cx,on as cy,Gh as cz,ia as d,nM as d$,Hy as d0,o0 as d1,Fo as d2,Ow as d3,jw as d4,Mw as d5,Tw as d6,dy as d7,au as d8,bw as d9,Qy as dA,Pw as dB,Ma as dC,Aw as dD,R0 as dE,qw as dF,P0 as dG,By as dH,Kt as dI,eM as dJ,Uu as dK,Qw as dL,pa as dM,da as dN,ua as dO,ha as dP,He as dQ,nv as dR,ov as dS,Xu as dT,Wu as dU,hM as dV,Vu as dW,nt as dX,i_ as dY,rM as dZ,sM as d_,B1 as da,Hh as db,Re as dc,J1 as dd,x1 as de,S1 as df,ew as dg,s1 as dh,ug as di,na as dj,Kh as dk,iw as dl,ow as dm,vw as dn,p0 as dp,ly as dq,C1 as dr,Rw as ds,xw as dt,zw as du,c0 as dv,rw as dw,Lw as dx,Ri as dy,yn as dz,wm as e,ss as e$,qu as e0,gr as e1,u0 as e2,oM as e3,ma as e4,mn as e5,Bi as e6,ww as e7,jr as e8,Nw as e9,Mo as eA,oy as eB,ca as eC,q1 as eD,Xw as eE,Yw as eF,$0 as eG,k0 as eH,Ou as eI,Yh as eJ,F1 as eK,mg as eL,cw as eM,hw as eN,lw as eO,mw as eP,dw as eQ,pw as eR,uw as eS,pr as eT,Kw as eU,tw as eV,z1 as eW,nw as eX,En as eY,p_ as eZ,_n as e_,d0 as ea,Iw as eb,_a as ec,Hr as ed,gn as ee,Yt as ef,Ur as eg,by as eh,fa as ei,ga as ej,Lo as ek,Ca as el,Dw as em,Fa as en,cM as eo,lM as ep,iM as eq,K0 as er,tM as es,aM as et,uM as eu,Ia as ev,mc as ew,dM as ex,u_ as ey,pM as ez,t1 as f,vM as f$,cn as f0,Dy as f1,Sw as f2,$w as f3,_u as f4,Ew as f5,kw as f6,Ly as f7,Sa as f8,qs as f9,gw as fA,yw as fB,yt as fC,v as fD,be as fE,Me as fF,Ie as fG,Ch as fH,ny as fI,ry as fJ,_w as fK,mM as fL,Qt as fM,he as fN,xM as fO,Vo as fP,Oi as fQ,Q as fR,wM as fS,Qb as fT,Oo as fU,Vc as fV,Uc as fW,ix as fX,ye as fY,Bw as fZ,ld as f_,Fw as fa,Ea as fb,Mu as fc,Cw as fd,os as fe,wu as ff,fw as fg,vc as fh,x0 as fi,Uw as fj,Pn as fk,ls as fl,Vw as fm,zu as fn,Hw as fo,Pa as fp,as as fq,Gw as fr,v0 as fs,w0 as ft,Ww as fu,yM as fv,Xr as fw,Jw as fx,Sn as fy,Zw as fz,Xe as g,ab as g$,iv as g0,fM as g1,gM as g2,FM as g3,RM as g4,PM as g5,wr as g6,Mr as g7,Sr as g8,Cx as g9,Ib as gA,Rb as gB,Pb as gC,Fb as gD,Cb as gE,Ab as gF,Tb as gG,Eb as gH,kb as gI,$b as gJ,Sb as gK,Mb as gL,wb as gM,vb as gN,xb as gO,bb as gP,_b as gQ,yb as gR,gb as gS,fb as gT,mb as gU,pb as gV,db as gW,ub as gX,hb as gY,cb as gZ,lb as g_,TM as ga,Ax as gb,CM as gc,Tx as gd,Ex as ge,SM as gf,kx as gg,MM as gh,$x as gi,AM as gj,Mx as gk,EM as gl,wx as gm,$M as gn,vx as go,Sx as gp,xx as gq,Co as gr,IM as gs,bM as gt,rv as gu,sv as gv,qa as gw,_M as gx,Yr as gy,od as gz,Bt as h,ob as h0,sb as h1,rb as h2,nb as h3,ib as h4,tb as h5,eb as h6,Q_ as h7,K_ as h8,J_ as h9,Qx as hA,Z_ as ha,q_ as hb,Y_ as hc,X_ as hd,W_ as he,G_ as hf,H_ as hg,U_ as hh,V_ as hi,j_ as hj,O_ as hk,B_ as hl,z_ as hm,N_ as hn,L_ as ho,D_ as hp,I_ as hq,R_ as hr,P_ as hs,F_ as ht,C_ as hu,qx as hv,Xx as hw,zo as hx,kM as hy,Fx as hz,Rr as i,Et as j,ce as k,w1 as l,ag as m,et as n,Se as o,ne as p,Fh as q,xt as r,je as s,Ih as t,mo as u,M1 as v,Sl as w,A1 as x,Nm as y,ml as z};
