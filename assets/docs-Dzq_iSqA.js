import{$ as e,$t as t,At as n,Bt as r,Ct as i,Dt as a,Er as o,Et as s,Ft as c,Gt as ee,Ht as te,It as ne,J as re,Jt as ie,Kt as ae,Lt as oe,Mt as se,Nt as ce,Ot as le,Pr as l,Pt as ue,Q as de,Qt as fe,Rt as pe,S as u,St as me,Tr as d,Tt as he,Ut as ge,V as _e,Vt as ve,Wt as ye,X as be,Xs as f,Xt as xe,Y as Se,Ys as Ce,Yt as we,Z as Te,Zs as Ee,Zt as De,_t as Oe,a as ke,an as Ae,at as je,bt as Me,c as Ne,cn as Pe,ct as Fe,dt as Ie,en as Le,et as Re,ft as ze,gt as Be,hn as Ve,ht as He,i as Ue,in as We,it as Ge,jt as Ke,kt as qe,l as p,lt as Je,m as Ye,mt as Xe,nn as Ze,nt as Qe,o as $e,on as et,ot as tt,p as nt,pt as rt,q as m,qs as it,qt as at,r as ot,rn as st,rt as ct,s as lt,sn as h,st as ut,t as dt,tn as ft,tt as pt,u as g,ut as mt,vt as ht,wt as gt,x as _,xt as _t,yt as vt,zt as yt}from"./viewport-shell-CyvM_Asa.js";var v={id:`hello`,type:`panel`,title:`Hello docs fixture`,mount:({lang:e})=>f`
...
`;function xt(){let o=Object.entries(Object.assign({"../../ui/svg/apply-transform.svg":et,"../../ui/svg/camera-dslr.svg":Ae,"../../ui/svg/camera-frames.svg":We,"../../ui/svg/camera-property.svg":st,"../../ui/svg/camera.svg":Ze,"../../ui/svg/chevron-down.svg":ft,"../../ui/svg/chevron-left.svg":Le,"../../ui/svg/chevron-right.svg":t,"../../ui/svg/clock.svg":fe,"../../ui/svg/close.svg":De,"../../ui/svg/copy-to-camera.svg":xe,"../../ui/svg/copy-to-viewport.svg":we,"../../ui/svg/cursor.svg":ie,"../../ui/svg/duplicate.svg":at,"../../ui/svg/export-tab.svg":ae,"../../ui/svg/export.svg":ee,"../../ui/svg/eye-off.svg":ye,"../../ui/svg/eye.svg":ge,"../../ui/svg/folder-open.svg":te,"../../ui/svg/frame-plus.svg":ve,"../../ui/svg/frame.svg":r,"../../ui/svg/grip.svg":yt,"../../ui/svg/help.svg":pe,"../../ui/svg/image.svg":oe,"../../ui/svg/keyframe.svg":ne,"../../ui/svg/lens.svg":c,"../../ui/svg/light.svg":ue,"../../ui/svg/link.svg":ce,"../../ui/svg/lock-open.svg":se,"../../ui/svg/lock.svg":Ke,"../../ui/svg/mask-all.svg":n,"../../ui/svg/mask-selected.svg":qe,"../../ui/svg/mask.svg":le,"../../ui/svg/menu.svg":a,"../../ui/svg/move.svg":s,"../../ui/svg/package-open.svg":he,"../../ui/svg/package.svg":gt,"../../ui/svg/paste.svg":i,"../../ui/svg/pause.svg":me,"../../ui/svg/pie-menu.svg":_t,"../../ui/svg/pin.svg":Me,"../../ui/svg/pivot.svg":vt,"../../ui/svg/play.svg":ht,"../../ui/svg/plus.svg":Oe,"../../ui/svg/redo.svg":Be,"../../ui/svg/reference-preview-off.svg":He,"../../ui/svg/reference-preview-on.svg":Xe,"../../ui/svg/reference-tool.svg":rt,"../../ui/svg/reference.svg":ze,"../../ui/svg/render-box.svg":Ie,"../../ui/svg/reset.svg":mt,"../../ui/svg/ruler.svg":Je,"../../ui/svg/save.svg":Fe,"../../ui/svg/scene.svg":ut,"../../ui/svg/scrub.svg":tt,"../../ui/svg/selection-clear.svg":je,"../../ui/svg/settings.svg":Ge,"../../ui/svg/skip-back.svg":ct,"../../ui/svg/skip-forward.svg":Qe,"../../ui/svg/slash-circle.svg":pt,"../../ui/svg/splat-edit.svg":Re,"../../ui/svg/trash.svg":e,"../../ui/svg/undo.svg":de,"../../ui/svg/view.svg":Te,"../../ui/svg/viewport.svg":be,"../../ui/svg/zoom-out.svg":Se,"../../ui/svg/zoom.svg":re})).map(([e,t])=>{let n=e.match(/\/([^/]+)\.svg$/i),r=n?n[1]:null;return r&&typeof t==`string`?{name:r,rawSvg:t}:null}).filter(Boolean);return o.sort((e,t)=>e.name.localeCompare(t.name)),o}var y={id:`icons-all`,type:`reference`,title:`All workbench icons`,mount:({lang:e})=>{let t=xt();return f`
...
`,Dt={id:`app-layout-overview`,type:`composite`,title:`Full app layout overview`,annotations:[{n:1,selector:`.docs-layout-host__viewport`,label:`ビューポート`,placement:`center`},{n:2,selector:`.workbench-card--tool-rail`,label:`ツールレール`,placement:`center`},{n:3,selector:`.workbench-card--inspector`,label:`インスペクター`,placement:`center`},{n:4,selector:`.viewport-project-status`,label:`プロジェクト状態 HUD`,placement:`right`}],mount:({lang:e})=>{let t=E(`cf-test2-default`),n=D({locale:e,project:{name:`cf-test2`,dirty:!1,packageDirty:!0},history:{canUndo:!0,canRedo:!0},shotCamera:{positionX:1.23,positionY:2.45,positionZ:-.5,yawDeg:45,pitchDeg:-15,rollDeg:0}}),r=T({methods:{canFitOutputFrameToSafeArea:()=>!0}}),i=(t,n)=>o(e,t,n),a=[{id:`new-project`,icon:`plus`,label:i(`menu.newProjectAction`),shortcut:`Ctrl+N`},{id:`open-files`,icon:`folder-open`,label:i(`action.openFiles`),shortcut:`Ctrl+O`},{id:`save-project`,icon:`save`,label:i(`menu.saveWorkingStateAction`),shortcut:`Ctrl+S`},{id:`export-project`,icon:`package`,label:i(`menu.savePackageAction`),shortcut:`Ctrl+Shift+S`}],s=d(e);return f`
...
`,A={x:{x2:`92`,y2:`50`},y:{x2:`50`,y2:`8`},z:{x2:`50`,y2:`50`}},kt=[{key:`pos-x`,cls:`positive--x`,label:`X`,left:`92%`,top:`50%`},{key:`pos-y`,cls:`positive--y`,label:`Y`,left:`50%`,top:`8%`},{key:`pos-z`,cls:`positive--z`,label:`Z`,left:`50%`,top:`50%`},{key:`neg-x`,cls:`negative--x`,label:``,left:`8%`,top:`50%`},{key:`neg-y`,cls:`negative--y`,label:``,left:`50%`,top:`92%`},{key:`neg-z`,cls:`negative--z`,label:``,left:`50%`,top:`50%`}];function At(){return f`
	...
	`}var jt={id:`axis-gizmo`,type:`viewport`,title:`Viewport axis gizmo (orthographic posZ)`,mount:()=>{let e=E(`cf-test2-default`);return f`
...
`,Lt=[`top-left`,`top`,`top-right`,`right`,`bottom-right`,`bottom`,`bottom-left`,`left`],Rt=[`top`,`right`,`bottom`,`left`];function M({frames:e=[],anchorOffset:t={left:`50%`,top:`50%`}}={}){return f`
		<div
			id="render-box"
	...
	`}var zt={id:`camera-mode-render-box`,type:`viewport`,title:`Camera mode with render-box overlay`,mount:()=>{let e=E(`cf-test2-default`),{widthPct:t,heightPct:n}=j(1);return f`
			<div class="docs-viewport-host">
				<style>${It}</style>
				<img
					class="docs-viewport-host__backdrop"
...
`,Vt={id:`confirm-new-project`,type:`overlay`,title:`Confirm: New Project`,mount:()=>f`
			<div class="docs-overlay-host">
				<style>${Bt}</style>
				<${h} overlay=${{kind:`confirm`,title:`新規プロジェクトを作成しますか？`,message:`現在の作業は未保存の変更を含みます。新規プロジェクトを作成すると現在の作業は破棄されます。`,actions:[{label:`キャンセル`,onClick:()=>{}},{label:`破棄して新規作成`,primary:!0,onClick:()=>{}}]}} />
			</div>
		`},Ht=`
.docs-viewport-host {
	position: relative;
...
`,Ut={id:`drop-hint`,type:`viewport`,title:`Viewport drop hint (empty project)`,mount:({lang:e})=>{let t=(t,n)=>o(e,t,n);return f`
			<div class="docs-viewport-host">
				<style>${Ht}</style>
				<div class="drop-hint">
...
`,Gt={id:`export-output-section`,type:`panel`,title:`Export Output section`,size:{width:360},mount:({lang:e})=>{let t=D(),n=T();return f`
...
`,qt={id:`export-progress`,type:`overlay`,title:`Export progress overlay`,mount:()=>f`
			<div class="docs-overlay-host">
				<style>${Kt}</style>
				<${h} overlay=${{kind:`progress`,title:`書き出し中`,message:`すべての shot をレンダリングしています。`,startedAt:Date.now()-47*1e3,phaseLabel:`shot 2 / 4 をレンダリング`,phaseDetail:`Camera 2 — PSD 書き出し`,phases:[{label:`Camera 1`,status:`done`},{label:`Camera 2`,status:`active`},{label:`Camera 3`,status:`pending`},{label:`Camera 4`,status:`pending`}],steps:[{label:`projectをスナップショット`,status:`done`},{label:`各ショットをレンダリング`,status:`active`},{label:`zip アーカイブを生成`,status:`pending`}]}} />
			</div>
		`},Jt=`
.docs-section-host {
	padding: 24px;
...
`,Yt={id:`export-settings-section`,type:`panel`,title:`Export Settings section`,size:{width:360},mount:({lang:e})=>{let t=D(),n=T();return f`
			<div class="docs-section-host">
				<style>${Jt}</style>
				<div class="docs-section-host__card">
					<${Ne}
...
`,tn={id:`first-scene-loaded`,type:`viewport`,title:`Viewport after first scene load`,mount:()=>{let e=E(`cf-test2-default`);return f`
			<div class="docs-viewport-host">
				<style>${en}</style>
				<img
					class="docs-viewport-host__backdrop"
...
`,rn={id:`inspector-tabs`,type:`panel`,title:`Inspector tabs (Camera active)`,mount:({lang:e})=>f`
...
`,on={id:`lighting-widget`,type:`panel`,title:`Lighting Direction widget`,mount:()=>{let e=T();return f`
...
`,mn={id:`output-frame-section`,type:`panel`,title:`Output Frame section`,size:{width:360},mount:({lang:e})=>{let t=D(),n=T();return f`
			<div class="docs-section-host">
				<style>${pn}</style>
				<div class="docs-section-host__card">
					<${p}
...
`;function P({lang:e,coarse:t=!1}){let n=(t,n)=>o(e,t,n),r=Ve({mode:`camera`,t:n,viewportToolMode:`select`,viewportOrthographic:!1,referencePreviewSessionVisible:!0,hasReferenceImages:!1,frameMaskMode:`off`}),i=r.find(e=>e.id===`tool-select`)??null;return f`
		<div class="docs-pie-host">
			...
			>
				...
				${r.map(e=>{let t=Math.cos(e.angle)*88,n=Math.sin(e.angle)*88,r=[`viewport-pie__item`,e.id===i?.id||e.active?`viewport-pie__item--active`:``,e.disabled?`viewport-pie__item--disabled`:``].filter(Boolean).join(` `);return f`
						<button
							key=${e.id}
							type="button"
							class=${r}
...
`;function F(e,t){return{id:e,name:t,itemRefs:[]}}function I({id:e,name:t,fileName:n,group:r,order:i}){return{id:e,assetId:`asset-${e}`,name:t,fileName:n,group:r,order:i,previewVisible:!0,exportEnabled:!0,opacity:1,scalePct:100,rotationDeg:0,offsetPx:{x:0,y:0},anchor:{ax:.5,ay:.5}}}function L(e,t){let n=T();return f`
		<div class="docs-section-host">
			<style>${Mn}</style>
			<div class="docs-section-host__card">
				<${ke}
...
`,Bn={id:`section-display-zoom`,type:`panel`,title:`Display Zoom section`,size:{width:360},mount:({lang:e})=>{let t=D(),n=T();return f`
			<div class="docs-section-host">
				<style>${zn}</style>
				<div class="docs-section-host__card">
					<${$e}
...
`,Hn={id:`shot-camera-manager`,type:`panel`,title:`Shot Camera Manager list`,size:{width:360},annotations:[{n:1,selector:`#new-shot-camera`,label:`追加`,placement:`above`},{n:2,selector:`#duplicate-shot-camera`,label:`複製`,placement:`above`},{n:3,selector:`#delete-shot-camera`,label:`削除`,placement:`above`},{n:4,selector:`.shot-camera-manager__list`,label:`shot 一覧`,placement:`right`}],mount:({lang:e})=>{let t=l({id:`shot-camera-1`,name:`Camera 1`}),n=[t,l({id:`shot-camera-2`,name:`Camera 2`,source:t}),l({id:`shot-camera-3`,name:`Camera 3`,source:t})],r=n[1],i=T();return f`
			<div class="docs-section-host">
				<style>${Vn}</style>
				<div class="docs-section-host__card">
					<${Ye}
...
`,Wn={id:`shot-camera-properties`,type:`panel`,title:`Shot Camera Properties section`,size:{width:360},mount:({lang:e})=>{let t=D({shotCamera:{positionX:1.23,positionY:2.45,positionZ:-.5,yawDeg:45,pitchDeg:-15,rollDeg:0}}),n=T();return f`
			<div class="docs-section-host">
				<style>${Un}</style>
				<div class="docs-section-host__card">
					<${g}
...
`;function z(e,t){let n=T();return f`
...
`,Zn={id:`tool-rail`,type:`panel`,title:`Viewport tool rail`,mount:({lang:e})=>{let t=D(),n=T(),r=(t,n)=>o(e,t,n);return f`
...
`;x(Bn),x(Wn),x(Hn),x(mn),x(Yt),x(Gt),x(qt),x(Ut),x(tn),x(jt),x(Zn),x(zt),x(fn),x(In),x(cn),x(Nn),x(Pn),x(Vt),x(Qt),x($t),x(rn),x(vn),x(yn),x(jn),x(Kn),x(qn),x(Jn),x(Yn),x(nr),x({id:`transform-gizmo`,type:`viewport`,title:`Transform gizmo over selected asset`,mount:()=>{let e=E(`cf-test2-default`),t={x:466.5,y:320.5},n={x:Y-Z*.1,y:X-Z*.98},r={x:435,y:362.5};return f`
			<div class="docs-viewport-host">
				<style>${ar}</style>
				<img
					class="docs-viewport-host__backdrop"
...
`;function cr({fixtureId:e,available:t}){return f`
	...
	`}function dr({fixtureId:e,lang:t}){let n=St(e);if(!n)return f`<${cr}
			fixtureId=${e}
			available=${S()}
		/>`;let r=Array.isArray(n.annotations)?n.annotations:[];return f`
		<div
			class="docs-stage"
