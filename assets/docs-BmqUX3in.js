import{f9 as Le,fM as ne,gy as ae,fD as l,fR as le,fQ as I,gz as C,gA as Me,gB as De,gC as Ue,gD as Ne,gE as He,gF as Ve,gG as Ye,gH as Be,gI as We,gJ as Ge,gK as Xe,gL as Ke,gM as Ze,gN as qe,gO as Qe,gP as Je,gQ as et,gR as tt,gS as ot,gT as st,gU as it,gV as rt,gW as nt,gX as at,gY as lt,gZ as ct,g_ as dt,g$ as pt,h0 as ut,h1 as gt,h2 as bt,h3 as ht,h4 as vt,h5 as mt,h6 as _t,h7 as ft,h8 as yt,h9 as $t,ha as xt,hb as wt,hc as kt,hd as St,he as It,hf as Et,hg as Tt,hh as zt,hi as Rt,hj as At,hk as Ct,hl as Ot,hm as Ft,hn as Pt,ho as jt,hp as Lt,hq as Mt,hr as Dt,hs as Ut,ht as Nt,hu as Ht,gx as Vt,fZ as _e,g3 as fe,hv as Yt,g4 as ye,gl as $e,gj as xe,cM as h,gt as we,gc as Bt,ga as Wt,fE as Z,fO as Gt,hw as Xt,ey as Kt,hx as ce,fS as Zt,hy as qt,cW as X,hz as Qt,hA as Jt,gw as eo,fY as to,fG as oo}from"./viewport-shell-esa7NrEp.js";function so({controller:e,open:t=!0,summaryActions:o=null,onToggle:s=null,showList:n=!0,store:c,t:i}){var te,oe;const b=c.referenceImages.assets.value,g=c.referenceImages.items.value,F=Le(g),G=c.referenceImages.presets.value,A=c.referenceImages.previewSessionVisible.value,Ce=c.referenceImages.selectedAssetId.value,J=c.referenceImages.selectedItemId.value,Oe=new Set(c.referenceImages.selectedItemIds.value??[]),Fe=c.referenceImages.panelPresetId.value,u=g.find(r=>r.id===J)??null,ee=b.find(r=>r.id===((u==null?void 0:u.assetId)??Ce))??null,Pe=(r,a,d)=>{var f,se,P,ie,j,re;(se=(f=e())==null?void 0:f.selectReferenceImageItem)==null||se.call(f,a,{additive:r.ctrlKey||r.metaKey,toggle:r.ctrlKey||r.metaKey,range:r.shiftKey,orderedIds:d}),(ie=(P=e())==null?void 0:P.isReferenceImageSelectionActive)!=null&&ie.call(P)&&((re=(j=e())==null?void 0:j.activateViewportReferenceImageEditModeImplicit)==null||re.call(j))};function je({selected:r=!1,active:a=!1}){const d=["scene-asset-row"];return r&&d.push("scene-asset-row--selected"),a&&d.push("scene-asset-row--active"),d.join(" ")}return l`
		<${ne}
			icon="image"
...
`;function ro(){const t=Object.entries(Object.assign({"../../ui/svg/apply-transform.svg":Ht,"../../ui/svg/camera-dslr.svg":Nt,"../../ui/svg/camera-frames.svg":Ut,"../../ui/svg/camera-property.svg":Dt,"../../ui/svg/camera.svg":Mt,"../../ui/svg/chevron-left.svg":Lt,"../../ui/svg/chevron-right.svg":jt,"../../ui/svg/clock.svg":Pt,"../../ui/svg/close.svg":Ft,"../../ui/svg/copy-to-camera.svg":Ot,"../../ui/svg/copy-to-viewport.svg":Ct,"../../ui/svg/cursor.svg":At,"../../ui/svg/duplicate.svg":Rt,"../../ui/svg/export-tab.svg":zt,"../../ui/svg/export.svg":Tt,"../../ui/svg/eye-off.svg":Et,"../../ui/svg/eye.svg":It,"../../ui/svg/folder-open.svg":St,"../../ui/svg/frame-plus.svg":kt,"../../ui/svg/frame.svg":wt,"../../ui/svg/grip.svg":xt,"../../ui/svg/help.svg":$t,"../../ui/svg/image.svg":yt,"../../ui/svg/lens.svg":ft,"../../ui/svg/light.svg":_t,"../../ui/svg/link.svg":mt,"../../ui/svg/lock-open.svg":vt,"../../ui/svg/lock.svg":ht,"../../ui/svg/mask-all.svg":bt,"../../ui/svg/mask-selected.svg":gt,"../../ui/svg/mask.svg":ut,"../../ui/svg/menu.svg":pt,"../../ui/svg/move.svg":dt,"../../ui/svg/package-open.svg":ct,"../../ui/svg/package.svg":lt,"../../ui/svg/pie-menu.svg":at,"../../ui/svg/pin.svg":nt,"../../ui/svg/pivot.svg":rt,"../../ui/svg/plus.svg":it,"../../ui/svg/redo.svg":st,"../../ui/svg/reference-preview-off.svg":ot,"../../ui/svg/reference-preview-on.svg":tt,"../../ui/svg/reference-tool.svg":et,"../../ui/svg/reference.svg":Je,"../../ui/svg/render-box.svg":Qe,"../../ui/svg/reset.svg":qe,"../../ui/svg/ruler.svg":Ze,"../../ui/svg/save.svg":Ke,"../../ui/svg/scene.svg":Xe,"../../ui/svg/scrub.svg":Ge,"../../ui/svg/selection-clear.svg":We,"../../ui/svg/settings.svg":Be,"../../ui/svg/slash-circle.svg":Ye,"../../ui/svg/splat-edit.svg":Ve,"../../ui/svg/trash.svg":He,"../../ui/svg/undo.svg":Ne,"../../ui/svg/view.svg":Ue,"../../ui/svg/viewport.svg":De,"../../ui/svg/zoom.svg":Me})).map(([o,s])=>{const n=o.match(/\/([^/]+)\.svg$/i),c=n?n[1]:null;return c&&typeof s=="string"?{name:c,rawSvg:s}:null}).filter(Boolean);return t.sort((o,s)=>o.name.localeCompare(s.name)),t}const pe={id:"icons-all",type:"reference",title:"All workbench icons",mount:({lang:e})=>{const t=ro();return l`
		...
		`}},U={[de.id]:de,[pe.id]:pe};function p(e){if(!e||typeof e.id!="string"||e.id.length===0)throw new Error("registerFixture: fixture.id must be a non-empty string");if(Object.hasOwn(U,e.id))throw new Error(`registerFixture: duplicate id "${e.id}"`);U[e.id]=e}function no(e){return typeof e!="string"||e===""?null:U[e]??null}function ke(){return Object.keys(U)}const ue="__calls",ge="__methods";function m(e={}){const t=e.log===!0,o=e.methods??null,s=[],n={[ue]:s,[ge]:o};return new Proxy(n,{get(c,i){if(typeof i!="string")return Reflect.get(c,i);if(i===ue)return s;if(i===ge)return o;const b=o&&Object.hasOwn(o,i)?o[i]:null;return(...g)=>{if(s.push({method:i,args:g}),t&&console.debug(`[mock-controller] ${i}`,g),b)return b(...g)}}})}const ao="/camera-frames/docs/help/assets/fixture-backdrops/",lo={"cf-test2-default":{id:"cf-test2-default",backdropUrl:`${ao}cf-test2-default.png`,width:1073,height:1264,description:"cf-test2 の仮のシーン（権利クリア済みの motorbike スプラット）"}};function k(e){const t=lo[e];if(!t)throw new Error(`makeScene: unknown scene "${e}"`);return t}function v(e={}){const t=Vt(null);return Se(t,e,[]),t}function Se(e,t,o){for(const[s,n]of Object.entries(t)){const c=o.concat(s),i=e==null?void 0:e[s];if(i==null)throw new Error(`createMockStore: unknown path "${c.join(".")}"`);if(co(i)){po(i,n,c);continue}if(be(i)&&be(n)){Se(i,n,c);continue}throw new Error(`createMockStore: cannot assign "${c.join(".")}" — target is neither a signal nor a namespace`)}}function co(e){return e!==null&&typeof e=="object"&&"value"in e&&typeof e.peek=="function"}function be(e){if(e===null||typeof e!="object"||Array.isArray(e))return!1;const t=Object.getPrototypeOf(e);return t===Object.prototype||t===null}function po(e,t,o){try{e.value=t}catch(s){const n=s instanceof Error?s.message:String(s);throw new Error(`createMockStore: cannot assign to "${o.join(".")}" (computed or read-only): ${n}`)}}const uo=960,go=600,bo=`
.docs-layout-host {
	position: relative;
	width: ${uo}px;
	height: ${go}px;
...
`,he={x:{x2:"92",y2:"50"},y:{x2:"50",y2:"8"},z:{x2:"50",y2:"50"}},fo=[{key:"pos-x",cls:"positive--x",label:"X",left:"92%",top:"50%"},{key:"pos-y",cls:"positive--y",label:"Y",left:"50%",top:"8%"},{key:"pos-z",cls:"positive--z",label:"Z",left:"50%",top:"50%"},{key:"neg-x",cls:"negative--x",label:"",left:"8%",top:"50%"},{key:"neg-y",cls:"negative--y",label:"",left:"50%",top:"92%"},{key:"neg-z",cls:"negative--z",label:"",left:"50%",top:"50%"}];function yo(){return l`
	...
	`}const $o={id:"axis-gizmo",type:"viewport",title:"Viewport axis gizmo (orthographic posZ)",mount:()=>{const e=k("cf-test2-default");return l`
		...
		`}},N=800,H=560,Ie=110,Ee=70,q=580,Q=420,xo="rgba(255, 87, 72, 0.92)",ve="rgba(255, 182, 170, 0.98)",wo="rgba(255, 87, 72, 0.18)",ko="#ffd8d1";function V(e){return{widthPct:e*(1536/1754)*100,heightPct:e*(864/1240)*100}}const So=`
.docs-viewport-host {
	position: relative;
	width: ${N}px;
	height: ${H}px;
...
`,Io=["top-left","top","top-right","right","bottom-right","bottom","bottom-left","left"],Eo=["top","right","bottom","left"];function Y({frames:e=[],anchorOffset:t={left:"50%",top:"50%"}}={}){return l`
		<div
			id="render-box"
		...
		>
			${e.map(o=>l`
					<div
						...
						style=${{left:o.left,top:o.top,width:o.width,height:o.height,border:`2px solid ${xo}`,boxSizing:"border-box",background:"transparent",boxShadow:o.active?`inset 0 0 0 1px ${ve}`:"none"}}
					>
						${o.active&&l`
							<span
								aria-hidden="true"
						...
						`}
						<span
							style=${{position:"absolute",top:"-22px",left:"0",padding:"2px 9px",borderRadius:"999px",background:wo,color:ko,fontFamily:'"Consolas", "Andale Mono", monospace',fontSize:"11px",fontWeight:600,letterSpacing:"0.05em",textTransform:"uppercase",whiteSpace:"nowrap"}}
						>
							${o.label}
						</span>
					</div>
	...
	`}const To={id:"camera-mode-render-box",type:"viewport",title:"Camera mode with render-box overlay",mount:()=>{const e=k("cf-test2-default"),{widthPct:t,heightPct:o}=V(1);return l`
			<div class="docs-viewport-host">
				<style>${So}</style>
				<img
					class="docs-viewport-host__backdrop"
...
`,Ro={id:"confirm-new-project",type:"overlay",title:"Confirm: New Project",mount:()=>l`
...
`,Fo={id:"drop-hint",type:"viewport",title:"Viewport drop hint (empty project)",mount:({lang:e})=>{const t=(o,s)=>h(e,o,s);return l`
			<div class="docs-viewport-host">
				<style>${Oo}</style>
				<div class="drop-hint">
...
`,jo={id:"export-output-section",type:"panel",title:"Export Output section",size:{width:360},mount:({lang:e})=>{const t=v(),o=m();return l`
...
`,Uo={id:"export-settings-section",type:"panel",title:"Export Settings section",size:{width:360},mount:({lang:e})=>{const t=v(),o=m();return l`
			<div class="docs-section-host">
				<style>${Do}</style>
				<div class="docs-section-host__card">
					<${Wt}
...
`,Ho=[{icon:"plus",labelKey:"menu.newProjectAction",shortcut:"Ctrl+N"},{icon:"folder-open",labelKey:"action.openFiles",shortcut:"Ctrl+O"},{icon:"save",labelKey:"menu.saveWorkingStateAction",shortcut:"Ctrl+S"},{icon:"package",labelKey:"menu.savePackageAction",shortcut:"Ctrl+Shift+S"}];function Te({lang:e,urlValue:t="",focusRing:o=!1}){const s=n=>h(e,n);return l`
	...
	`}const Vo={id:"open-menu",type:"overlay",title:"Tool Rail File menu (open)",mount:({lang:e})=>Te({lang:e})},Yo={id:"remote-url-input",type:"overlay",title:"Remote URL input (focused)",mount:({lang:e})=>Te({lang:e,urlValue:"https://example.com/scene.spz",focusRing:!0})},Bo=800,Wo=560,Go=`
.docs-viewport-host {
	position: relative;
	width: ${Bo}px;
	height: ${Wo}px;
...
`,Xo={id:"first-scene-loaded",type:"viewport",title:"Viewport after first scene load",mount:()=>{const e=k("cf-test2-default");return l`
			<div class="docs-viewport-host">
				<style>${Go}</style>
				<img
					class="docs-viewport-host__backdrop"
...
`,Zo={id:"inspector-tabs",type:"panel",title:"Inspector tabs (Camera active)",mount:({lang:e})=>l`
...
`,is=[{id:"frame-1",label:"FRAME A",center:{x:.5,y:.5},scale:1,active:!1},{id:"frame-2",label:"FRAME B",center:{x:.5755,y:.5169},scale:.5537,active:!0}];function rs(e){const{widthPct:t,heightPct:o}=V(e.scale);return{id:e.id,label:e.label,active:e.active,left:`${e.center.x*100-t/2}%`,top:`${e.center.y*100-o/2}%`,width:`${t}%`,height:`${o}%`}}const ns={id:"multiple-frames",type:"viewport",title:"Camera mode with multiple frames (zoom-in / TU)",mount:()=>{const e=k("cf-test2-default");return l`
			<div class="docs-viewport-host">
				<style>${ss}</style>
				<img
					class="docs-viewport-host__backdrop"
...
`,ls={id:"output-frame-section",type:"panel",title:"Output Frame section",size:{width:360},mount:({lang:e})=>{const t=v(),o=m();return l`
			<div class="docs-section-host">
				<style>${as}</style>
				<div class="docs-section-host__card">
					<${xe}
...
`;function ze({lang:e,coarse:t=!1}){const o=(c,i)=>h(e,c,i),s=Kt({mode:"camera",t:o,viewportToolMode:"select",viewportOrthographic:!1,referencePreviewSessionVisible:!0,hasReferenceImages:!1,frameMaskMode:"off"}),n=s.find(c=>c.id==="tool-select")??null;return l`
	...
	`}const bs={id:"pie-menu",type:"overlay",title:"Viewport pie menu (open)",mount:({lang:e})=>ze({lang:e,coarse:!1})},hs={id:"pie-menu-expanded",type:"overlay",title:"Viewport pie menu (coarse / expanded)",mount:({lang:e})=>ze({lang:e,coarse:!0})},vs=800,ms=560,_s=200,fs=110,ys=400,$s=300,xs=-4,ws=`
.docs-viewport-host {
	position: relative;
	width: ${vs}px;
	height: ${ms}px;
...
`,ks=["top","right","bottom","left"],Ss=["top-left","top","top-right","right","bottom-right","bottom","bottom-left","left"],Is=["top-left","top","top-right","right","bottom-right","bottom","bottom-left","left"],Es={id:"reference-edit-mode",type:"viewport",title:"Reference image edit mode",mount:()=>{const e=k("cf-test2-default"),t={left:`${_s}px`,top:`${fs}px`,width:`${ys}px`,height:`${$s}px`,transform:`rotate(${xs}deg)`,transformOrigin:"50% 50%"};return l`
			<div class="docs-viewport-host">
				<style>${ws}</style>
				<img
					class="docs-viewport-host__backdrop"
...
`,Cs={id:"render-box-camera-mode",type:"viewport",title:"Render-box in camera mode (annotated)",annotations:[{n:1,selector:".render-box__resize-handle--top-right",label:"リサイズハンドル（8 方向）",placement:"top-right"},{n:2,selector:".render-box__pan-edge--top",label:"パンエッジ（4 辺）",placement:"above"},{n:3,selector:"#anchor-dot",label:"anchor dot",placement:"right"},{n:4,selector:"#render-box-meta",label:"meta ラベル",placement:"left"}],mount:()=>{const e=k("cf-test2-default"),{widthPct:t,heightPct:o}=V(1);return l`
			<div class="docs-viewport-host">
				<style>${As}</style>
				<img
					class="docs-viewport-host__backdrop"
...
`;function O({id:e,kind:t,label:o,visible:s=!0}){return{id:e,kind:t,label:o,visible:s}}const Fs={id:"scene-manager",type:"panel",title:"Scene Manager (kind-grouped asset list)",size:{width:360},mount:({lang:e})=>{const t=[O({id:1,kind:"model",label:"Environment.glb"}),O({id:2,kind:"model",label:"Figure.glb"}),O({id:3,kind:"splat",label:"MainScan.ply"}),O({id:4,kind:"splat",label:"Foreground.spz",visible:!1}),O({id:5,kind:"splat",label:"Background.ply"})],o=t[2],s=v({selectedSceneAssetIds:[o.id],selectedSceneAssetId:o.id}),n=m();return l`
			<div class="docs-section-host">
				<style>${Os}</style>
				<div class="docs-section-host__card">
					<${Zt}
...
`,js={id:"section-display-zoom",type:"panel",title:"Display Zoom section",size:{width:360},mount:({lang:e})=>{const t=v(),o=m();return l`
			<div class="docs-section-host">
				<style>${Ps}</style>
				<div class="docs-section-host__card">
					<${qt}
...
`,Us={id:"shot-camera-properties",type:"panel",title:"Shot Camera Properties section",size:{width:360},mount:({lang:e})=>{const t=v({shotCamera:{positionX:1.23,positionY:2.45,positionZ:-.5,yawDeg:45,pitchDeg:-15,rollDeg:0}}),o=m();return l`
			<div class="docs-section-host">
				<style>${Ds}</style>
				<div class="docs-section-host__card">
					<${$e}
...
`;function B(e,t){const o=m();return l`
	...
	`}const Hs={id:"splat-edit-toolbar",type:"overlay",title:"Splat edit toolbar (box tool, unplaced)",mount:({lang:e})=>{const t=v({viewportToolMode:"splat-edit"});return B(t,e)}},Vs={id:"per-splat-brush-preview",type:"overlay",title:"Splat edit toolbar (brush tool)",mount:({lang:e})=>{const t=v({viewportToolMode:"splat-edit",splatEdit:{tool:"brush",brushSize:30,brushDepthMode:"depth",brushDepth:.2}});return B(t,e)}},Ys={id:"per-splat-box-tool",type:"overlay",title:"Splat edit toolbar (box tool, placed)",mount:({lang:e})=>{const t=v({viewportToolMode:"splat-edit",splatEdit:{tool:"box",boxPlaced:!0,boxCenter:{x:.5,y:1.2,z:-.3},boxSize:{x:1,y:.6,z:1.4},boxRotation:{x:0,y:0,z:0,w:1},selectionCount:12345}});return B(t,e)}},Bs={id:"per-splat-edit-toolbar",type:"overlay",title:"Splat edit toolbar (annotated)",annotations:[{n:1,selector:".viewport-splat-edit-toolbar__bar > .viewport-splat-edit-toolbar__group:nth-of-type(1)",label:"Tool 選択"},{n:2,selector:".viewport-splat-edit-toolbar__bar > .viewport-splat-edit-toolbar__group:nth-of-type(3)",label:"選択操作"},{n:3,selector:".viewport-splat-edit-toolbar__bar > .viewport-splat-edit-toolbar__group:nth-of-type(5)",label:"編集アクション"},{n:4,selector:".viewport-splat-edit-toolbar__bar > .viewport-splat-edit-toolbar__info",label:"選択数"}],mount:({lang:e})=>{const t=v({viewportToolMode:"splat-edit",splatEdit:{tool:"box",selectionCount:42}});return B(t,e)}},Ws=`
.docs-rail-host {
	padding: 24px;
	display: inline-block;
	background: #08111d;
...
`,Gs={id:"tool-rail",type:"panel",title:"Viewport tool rail",mount:({lang:e})=>{const t=v(),o=m(),s=(n,c)=>h(e,n,c);return l`
...
`,S=[{id:"frame-1",label:"FRAME A",center:{x:.3933,y:.5404},scale:1,active:!1,tangent:{in:{x:-.0874,y:.0026},out:{x:.0874,y:-.0026}}},{id:"frame-2",label:"FRAME B",center:{x:.6461,y:.4232},scale:.8549,active:!0,tangent:{in:{x:-.077,y:.0809},out:{x:.077,y:-.0809}}}];function Ae(e,t){return{x:Ie+q*e,y:Ee+Q*t}}function Ks(e){const{widthPct:t,heightPct:o}=V(e.scale);return{id:e.id,label:e.label,active:e.active,left:e.center.x*100-t/2,top:e.center.y*100-o/2,width:t,height:o}}const Zs=S.map(Ks),x=Ae(S[0].center.x,S[0].center.y),w=Ae(S[1].center.x,S[1].center.y);function W(e,t){return{x:e.x+t.x*q,y:e.y+t.y*Q}}const L=W(x,S[0].tangent.in),E=W(x,S[0].tangent.out),T=W(w,S[1].tangent.in),M=W(w,S[1].tangent.out);function qs(e){return{id:e.id,label:e.label,active:e.active,left:`${e.left}%`,top:`${e.top}%`,width:`${e.width}%`,height:`${e.height}%`}}const Qs={id:"trajectory-spline",type:"viewport",title:"Camera mode with spline trajectory (cf-test2 Camera 3)",mount:()=>{const e=k("cf-test2-default");return l`
			<div class="docs-viewport-host">
				<style>${Xs}</style>
				<img
					class="docs-viewport-host__backdrop"
		...
		`}},Js=800,ei=560,y=400,$=310,z=70,R=90,ti=`
.docs-viewport-host {
	position: relative;
	width: ${Js}px;
	height: ${ei}px;
...
`,oi={id:"transform-gizmo",type:"viewport",title:"Transform gizmo over selected asset",mount:()=>{const e=k("cf-test2-default"),t={x:y+z*.95,y:$+z*.15},o={x:y-z*.1,y:$-z*.98},s={x:y+z*.5,y:$+z*.75};return l`
			<div class="docs-viewport-host">
				<style>${ti}</style>
				<img
					class="docs-viewport-host__backdrop"
		...
		`}};p(js);p(Us);p(Ms);p(ls);p(Uo);p(jo);p(Mo);p(Fo);p(Xo);p($o);p(Gs);p(To);p(ns);p(Cs);p(os);p(zs);p(Rs);p(Ro);p(Vo);p(Yo);p(Zo);p(bs);p(hs);p(Es);p(Hs);p(Vs);p(Ys);p(Bs);p(Qs);p(oi);p(ho);p(Fs);p(Qo);const si="ja",ii=`
...
`;function ri({fixtureId:e,available:t}){return l`
	...
	`}const ni=15,ai=3,_=ni+ai;function li(e,t,o){const s=e.left-t.left,n=e.top-t.top,c=e.right-t.left,i=e.bottom-t.top,b=s+e.width/2,g=n+e.height/2;switch(o){case"center":return{x:b,y:g};case"top-left":return{x:s-_,y:n-_};case"bottom-right":return{x:c+_,y:i+_};case"bottom-left":return{x:s-_,y:i+_};case"above":return{x:b,y:n-_};case"below":return{x:b,y:i+_};case"left":return{x:s-_,y:g};case"right":return{x:c+_,y:g};default:return{x:c+_,y:n-_}}}function ci({annotations:e}){const[t,o]=to([]);return oo(()=>{if(!Array.isArray(e)||e.length===0){o([]);return}const s=document.querySelector(".docs-stage");if(!s){o([]);return}const n=s.getBoundingClientRect(),c=e.map(i=>{const b=i.selector?s.querySelector(i.selector):null;if(!b)return{n:i.n,label:i.label??"",selector:i.selector??"",x:8,y:8,missing:!0};const g=b.getBoundingClientRect(),F=i.placement??"top-right",{x:G,y:A}=li(g,n,F);return{n:i.n,label:i.label??"",selector:i.selector,x:G,y:A,missing:!1}});o(c)},[e]),t.length===0?null:l`
	...
	`}function di({fixtureId:e,lang:t}){const o=no(e);if(!o)return l`<${ri}
			fixtureId=${e}
			available=${ke()}
		...
		>
			<style>${ii}</style>
			${o.mount({lang:t})}
			${s.length>0&&l`<${ci} annotations=${s}/>`}
		</div>
	`}function me(e,t){try{const o=new URL(globalThis.location.href).searchParams.get(e);return o===null?t:o}catch{return t}}function pi(e){let t=!1;const o=()=>{t||(t=!0,globalThis.__DOCS_FIXTURE_READY=!0,globalThis.__DOCS_FIXTURE_ID=e)};requestAnimationFrame(()=>{requestAnimationFrame(o)}),setTimeout(o,100)}function ui(){const e=document.getElementById("docs-root");if(!e)return;const t=me("fixture",""),o=me("lang",si);globalThis.__DOCS_FIXTURE_READY=!1,globalThis.__DOCS_FIXTURE_ID=t,globalThis.__DOCS_FIXTURE_IDS=ke(),eo(l`<${di} fixtureId=${t} lang=${o} />`,e),pi(t)}ui();
