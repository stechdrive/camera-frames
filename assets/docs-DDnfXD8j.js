import{f9 as Le,fK as ne,gx as ae,fC as l,fP as le,fO as I,gy as C,gz as Me,gA as De,gB as Ue,gC as Ne,gD as He,gE as Ve,gF as Ye,gG as Be,gH as We,gI as Ge,gJ as Xe,gK as Ke,gL as Ze,gM as qe,gN as Qe,gO as Je,gP as et,gQ as tt,gR as ot,gS as st,gT as it,gU as rt,gV as nt,gW as at,gX as lt,gY as ct,gZ as dt,g_ as pt,g$ as ut,h0 as gt,h1 as bt,h2 as ht,h3 as vt,h4 as mt,h5 as _t,h6 as ft,h7 as yt,h8 as $t,h9 as xt,ha as wt,hb as kt,hc as St,hd as It,he as Et,hf as Tt,hg as zt,hh as Rt,hi as At,hj as Ct,hk as Ot,hl as Ft,hm as Pt,hn as jt,ho as Lt,hp as Mt,hq as Dt,hr as Ut,hs as Nt,gw as Ht,fX as _e,g1 as fe,ht as Vt,g2 as ye,gj as $e,gh as xe,cM as h,gr as we,ga as Yt,g8 as Bt,fD as Z,fM as Wt,hu as Gt,ey as Xt,hv as ce,fQ as Kt,hw as Zt,cW as X,hx as qt,hy as Qt,gv as Jt,fW as eo,fF as to}from"./viewport-shell-ADKiL-el.js";function oo({controller:e,open:t=!0,summaryActions:o=null,onToggle:s=null,showList:n=!0,store:c,t:i}){var te,oe;const b=c.referenceImages.assets.value,g=c.referenceImages.items.value,F=Le(g),G=c.referenceImages.presets.value,A=c.referenceImages.previewSessionVisible.value,Ce=c.referenceImages.selectedAssetId.value,J=c.referenceImages.selectedItemId.value,Oe=new Set(c.referenceImages.selectedItemIds.value??[]),Fe=c.referenceImages.panelPresetId.value,u=g.find(r=>r.id===J)??null,ee=b.find(r=>r.id===((u==null?void 0:u.assetId)??Ce))??null,Pe=(r,a,d)=>{var f,se,P,ie,j,re;(se=(f=e())==null?void 0:f.selectReferenceImageItem)==null||se.call(f,a,{additive:r.ctrlKey||r.metaKey,toggle:r.ctrlKey||r.metaKey,range:r.shiftKey,orderedIds:d}),(ie=(P=e())==null?void 0:P.isReferenceImageSelectionActive)!=null&&ie.call(P)&&((re=(j=e())==null?void 0:j.activateViewportReferenceImageEditModeImplicit)==null||re.call(j))};function je({selected:r=!1,active:a=!1}){const d=["scene-asset-row"];return r&&d.push("scene-asset-row--selected"),a&&d.push("scene-asset-row--active"),d.join(" ")}return l`
		<${ne}
			icon="image"
