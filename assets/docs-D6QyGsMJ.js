import{f4 as Oe,fC as re,gp as ne,fu as n,fH as le,fG as S,gq as O,gr as Pe,gs as Ce,gt as Fe,gu as je,gv as Le,gw as Me,gx as De,gy as Ue,gz as Ne,gA as He,gB as Ve,gC as Ye,gD as Be,gE as We,gF as Ge,gG as Xe,gH as Ke,gI as Ze,gJ as qe,gK as Je,gL as Qe,gM as et,gN as tt,gO as ot,gP as st,gQ as it,gR as at,gS as rt,gT as nt,gU as lt,gV as ct,gW as dt,gX as pt,gY as ut,gZ as gt,g_ as bt,g$ as vt,h0 as ht,h1 as _t,h2 as mt,h3 as ft,h4 as yt,h5 as xt,h6 as $t,h7 as wt,h8 as kt,h9 as It,ha as St,hb as Et,hc as Tt,hd as zt,he as Rt,hf as At,hg as Ot,hh as Pt,hi as Ct,hj as Ft,hk as jt,gj as me,cY as v,go as Lt,g2 as Mt,g0 as Dt,hl as Ut,fv as Z,fW as Nt,fE as Ht,g9 as Vt,fP as Yt,eu as Bt,hm as ce,hn as Wt,fI as Gt,ho as Xt,d5 as X,hp as Kt,gb as Zt,fV as qt,gn as Jt,fO as Qt,fx as eo}from"./viewport-shell-RxOpseGr.js";function to({controller:e,open:t=!0,summaryActions:o=null,onToggle:s=null,showList:l=!0,store:c,t:i}){var te,oe;const b=c.referenceImages.assets.value,g=c.referenceImages.items.value,C=Oe(g),G=c.referenceImages.presets.value,A=c.referenceImages.previewSessionVisible.value,Ee=c.referenceImages.selectedAssetId.value,Q=c.referenceImages.selectedItemId.value,Te=new Set(c.referenceImages.selectedItemIds.value??[]),ze=c.referenceImages.panelPresetId.value,u=g.find(a=>a.id===Q)??null,ee=b.find(a=>a.id===((u==null?void 0:u.assetId)??Ee))??null,Re=(a,r,d)=>{var f,se,F,ie,j,ae;(se=(f=e())==null?void 0:f.selectReferenceImageItem)==null||se.call(f,r,{additive:a.ctrlKey||a.metaKey,toggle:a.ctrlKey||a.metaKey,range:a.shiftKey,orderedIds:d}),(ie=(F=e())==null?void 0:F.isReferenceImageSelectionActive)!=null&&ie.call(F)&&((ae=(j=e())==null?void 0:j.activateViewportReferenceImageEditModeImplicit)==null||ae.call(j))};function Ae({selected:a=!1,active:r=!1}){const d=["scene-asset-row"];return a&&d.push("scene-asset-row--selected"),r&&d.push("scene-asset-row--active"),d.join(" ")}return n`
		<${re}
			icon="image"
