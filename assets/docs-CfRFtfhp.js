import{f3 as Oe,fB as re,go as ne,ft as n,fG as le,fF as S,gp as O,gq as Pe,gr as Ce,gs as Fe,gt as je,gu as Le,gv as Me,gw as De,gx as Ue,gy as Ne,gz as He,gA as Ve,gB as Be,gC as Ye,gD as We,gE as Ge,gF as Xe,gG as Ke,gH as Ze,gI as qe,gJ as Je,gK as Qe,gL as et,gM as tt,gN as ot,gO as st,gP as it,gQ as at,gR as rt,gS as nt,gT as lt,gU as ct,gV as dt,gW as pt,gX as ut,gY as gt,gZ as bt,g_ as vt,g$ as ht,h0 as _t,h1 as mt,h2 as ft,h3 as yt,h4 as xt,h5 as $t,h6 as wt,h7 as kt,h8 as It,h9 as St,ha as Et,hb as Tt,hc as zt,hd as Rt,he as At,hf as Ot,hg as Pt,hh as Ct,hi as Ft,hj as jt,gi as me,cY as v,gn as Lt,g1 as Mt,f$ as Dt,hk as Ut,fu as Z,fV as Nt,fD as Ht,g8 as Vt,fO as Bt,et as Yt,hl as ce,hm as Wt,fH as Gt,hn as Xt,d5 as X,ho as Kt,ga as Zt,fU as qt,gm as Jt,fN as Qt,fw as eo}from"./viewport-shell-DgRVAQKJ.js";function to({controller:e,open:t=!0,summaryActions:o=null,onToggle:s=null,showList:l=!0,store:c,t:i}){var te,oe;const b=c.referenceImages.assets.value,g=c.referenceImages.items.value,C=Oe(g),G=c.referenceImages.presets.value,A=c.referenceImages.previewSessionVisible.value,Ee=c.referenceImages.selectedAssetId.value,Q=c.referenceImages.selectedItemId.value,Te=new Set(c.referenceImages.selectedItemIds.value??[]),ze=c.referenceImages.panelPresetId.value,u=g.find(a=>a.id===Q)??null,ee=b.find(a=>a.id===((u==null?void 0:u.assetId)??Ee))??null,Re=(a,r,d)=>{var f,se,F,ie,j,ae;(se=(f=e())==null?void 0:f.selectReferenceImageItem)==null||se.call(f,r,{additive:a.ctrlKey||a.metaKey,toggle:a.ctrlKey||a.metaKey,range:a.shiftKey,orderedIds:d}),(ie=(F=e())==null?void 0:F.isReferenceImageSelectionActive)!=null&&ie.call(F)&&((ae=(j=e())==null?void 0:j.activateViewportReferenceImageEditModeImplicit)==null||ae.call(j))};function Ae({selected:a=!1,active:r=!1}){const d=["scene-asset-row"];return a&&d.push("scene-asset-row--selected"),r&&d.push("scene-asset-row--active"),d.join(" ")}return n`
		<${re}
			icon="image"
...
`;function ke({lang:e,coarse:t=!1}){const o=(c,i)=>v(e,c,i),s=Yt({mode:"camera",t:o,viewportToolMode:"select",viewportOrthographic:!1,referencePreviewSessionVisible:!0,hasReferenceImages:!1,frameMaskMode:"off"}),l=s.find(c=>c.id==="tool-select")??null;return n`
...
`,Bs={id:"shot-camera-properties",type:"panel",title:"Shot Camera Properties section",size:{width:360},mount:({lang:e})=>{const t=h({shotCamera:{positionX:1.23,positionY:2.45,positionZ:-.5,yawDeg:45,pitchDeg:-15,rollDeg:0}}),o=m();return n`
			<div class="docs-section-host">
				<style>${Vs}</style>
				<div class="docs-section-host__card">
					<${Zt}
...
`,ti={id:"transform-gizmo",type:"viewport",title:"Transform gizmo over selected asset",mount:()=>{const e=k("cf-test2-default"),t={x:y+z*.95,y:x+z*.15},o={x:y-z*.1,y:x-z*.98},s={x:y+z*.5,y:x+z*.75};return n`
		...
		`}};p(Us);p(Bs);p(Hs);p(cs);p(Do);p(Fo);p(Lo);p(Ao);p(Vo);p(mo);p(Ws);p(Io);p(qo);p(Qo);p(Go);p(Ls);p(Ms);p(Eo);p(os);p(ss);p(as);p(vs);p(hs);p(Ps);p(ms);p(fs);p(ys);p(xs);p(qs);p(ti);p(uo);p(Fs);p(ns);const oi="ja",si=`
