import{f9 as Oe,fK as re,gx as ne,fC as n,fP as le,fO as S,gy as O,gz as Pe,gA as Ce,gB as Fe,gC as je,gD as Le,gE as Me,gF as De,gG as Ue,gH as Ne,gI as He,gJ as Ve,gK as Be,gL as Ye,gM as We,gN as Ge,gO as Xe,gP as Ke,gQ as qe,gR as Ze,gS as Je,gT as Qe,gU as et,gV as tt,gW as ot,gX as st,gY as it,gZ as at,g_ as rt,g$ as nt,h0 as lt,h1 as ct,h2 as dt,h3 as pt,h4 as ut,h5 as gt,h6 as bt,h7 as ht,h8 as vt,h9 as _t,ha as mt,hb as ft,hc as yt,hd as xt,he as $t,hf as wt,hg as kt,hh as It,hi as St,hj as Et,hk as Tt,hl as zt,hm as Rt,hn as At,ho as Ot,hp as Pt,hq as Ct,hr as Ft,hs as jt,gr as me,cM as h,gw as Lt,ga as Mt,g8 as Dt,ht as Ut,fD as q,g2 as Nt,fM as Ht,gh as Vt,fX as Bt,ey as Yt,hu as ce,hv as Wt,fQ as Gt,hw as Xt,cW as X,hx as Kt,gj as qt,g1 as Zt,gv as Jt,fW as Qt,fF as eo}from"./viewport-shell-CXmH8qjD.js";function to({controller:e,open:t=!0,summaryActions:o=null,onToggle:s=null,showList:l=!0,store:c,t:i}){var te,oe;const b=c.referenceImages.assets.value,g=c.referenceImages.items.value,C=Oe(g),G=c.referenceImages.presets.value,A=c.referenceImages.previewSessionVisible.value,Ee=c.referenceImages.selectedAssetId.value,Q=c.referenceImages.selectedItemId.value,Te=new Set(c.referenceImages.selectedItemIds.value??[]),ze=c.referenceImages.panelPresetId.value,u=g.find(a=>a.id===Q)??null,ee=b.find(a=>a.id===((u==null?void 0:u.assetId)??Ee))??null,Re=(a,r,d)=>{var f,se,F,ie,j,ae;(se=(f=e())==null?void 0:f.selectReferenceImageItem)==null||se.call(f,r,{additive:a.ctrlKey||a.metaKey,toggle:a.ctrlKey||a.metaKey,range:a.shiftKey,orderedIds:d}),(ie=(F=e())==null?void 0:F.isReferenceImageSelectionActive)!=null&&ie.call(F)&&((ae=(j=e())==null?void 0:j.activateViewportReferenceImageEditModeImplicit)==null||ae.call(j))};function Ae({selected:a=!1,active:r=!1}){const d=["scene-asset-row"];return a&&d.push("scene-asset-row--selected"),r&&d.push("scene-asset-row--active"),d.join(" ")}return n`
		<${re}
			icon="image"
...
`,Ko=[{id:"frame-1",label:"FRAME A",center:{x:.5,y:.5},scale:1,active:!1},{id:"frame-2",label:"FRAME B",center:{x:.5755,y:.5169},scale:.5537,active:!0}];function qo(e){const{widthPct:t,heightPct:o}=V(e.scale);return{id:e.id,label:e.label,active:e.active,left:`${e.center.x*100-t/2}%`,top:`${e.center.y*100-o/2}%`,width:`${t}%`,height:`${o}%`}}const Zo={id:"multiple-frames",type:"viewport",title:"Camera mode with multiple frames (zoom-in / TU)",mount:()=>{const e=k("cf-test2-default");return n`
			<div class="docs-viewport-host">
				<style>${Xo}</style>
				<img
					class="docs-viewport-host__backdrop"
...
`,cs={id:"output-frame-section",type:"panel",title:"Output Frame section",size:{width:360},mount:({lang:e})=>{const t=v(),o=m();return n`
			<div class="docs-section-host">
				<style>${ls}</style>
				<div class="docs-section-host__card">
					<${Vt}
...
`;function ke({lang:e,coarse:t=!1}){const o=(c,i)=>h(e,c,i),s=Yt({mode:"camera",t:o,viewportToolMode:"select",viewportOrthographic:!1,referencePreviewSessionVisible:!0,hasReferenceImages:!1,frameMaskMode:"off"}),l=s.find(c=>c.id==="tool-select")??null;return n`
	...
	`}const hs={id:"pie-menu",type:"overlay",title:"Viewport pie menu (open)",mount:({lang:e})=>ke({lang:e,coarse:!1})},vs={id:"pie-menu-expanded",type:"overlay",title:"Viewport pie menu (coarse / expanded)",mount:({lang:e})=>ke({lang:e,coarse:!0})},_s=`
...
`;function Y(e,t){const o=m();return n`
	...
	`}const ms={id:"splat-edit-toolbar",type:"overlay",title:"Splat edit toolbar (box tool, unplaced)",mount:({lang:e})=>{const t=v({viewportToolMode:"splat-edit"});return Y(t,e)}},fs={id:"per-splat-brush-preview",type:"overlay",title:"Splat edit toolbar (brush tool)",mount:({lang:e})=>{const t=v({viewportToolMode:"splat-edit",splatEdit:{tool:"brush",brushSize:30,brushDepthMode:"depth",brushDepth:.2}});return Y(t,e)}},ys={id:"per-splat-box-tool",type:"overlay",title:"Splat edit toolbar (box tool, placed)",mount:({lang:e})=>{const t=v({viewportToolMode:"splat-edit",splatEdit:{tool:"box",boxPlaced:!0,boxCenter:{x:.5,y:1.2,z:-.3},boxSize:{x:1,y:.6,z:1.4},boxRotation:{x:0,y:0,z:0,w:1},selectionCount:12345}});return Y(t,e)}},xs={id:"per-splat-edit-toolbar",type:"overlay",title:"Splat edit toolbar (annotated)",annotations:[{n:1,selector:".viewport-splat-edit-toolbar__bar > .viewport-splat-edit-toolbar__group:nth-of-type(1)",label:"Tool 選択"},{n:2,selector:".viewport-splat-edit-toolbar__bar > .viewport-splat-edit-toolbar__group:nth-of-type(3)",label:"選択操作"},{n:3,selector:".viewport-splat-edit-toolbar__bar > .viewport-splat-edit-toolbar__group:nth-of-type(5)",label:"編集アクション"},{n:4,selector:".viewport-splat-edit-toolbar__bar > .viewport-splat-edit-toolbar__info",label:"選択数"}],mount:({lang:e})=>{const t=v({viewportToolMode:"splat-edit",splatEdit:{tool:"box",selectionCount:42}});return Y(t,e)}},$s=800,ws=560,ks=200,Is=110,Ss=400,Es=300,Ts=-4,zs=`
.docs-viewport-host {
	position: relative;
	width: ${$s}px;
	height: ${ws}px;
...
`,Us={id:"section-display-zoom",type:"panel",title:"Display Zoom section",size:{width:360},mount:({lang:e})=>{const t=v(),o=m();return n`
			<div class="docs-section-host">
				<style>${Ds}</style>
				<div class="docs-section-host__card">
					<${Xt}
...
`,Bs={id:"shot-camera-properties",type:"panel",title:"Shot Camera Properties section",size:{width:360},mount:({lang:e})=>{const t=v({shotCamera:{positionX:1.23,positionY:2.45,positionZ:-.5,yawDeg:45,pitchDeg:-15,rollDeg:0}}),o=m();return n`
			<div class="docs-section-host">
				<style>${Vs}</style>
				<div class="docs-section-host__card">
					<${qt}
...
`,ti={id:"transform-gizmo",type:"viewport",title:"Transform gizmo over selected asset",mount:()=>{const e=k("cf-test2-default"),t={x:y+z*.95,y:x+z*.15},o={x:y-z*.1,y:x-z*.98},s={x:y+z*.5,y:x+z*.75};return n`
		...
		`}};p(Us);p(Bs);p(Hs);p(cs);p(Do);p(Fo);p(Lo);p(Ao);p(Vo);p(mo);p(Ws);p(Io);p(Zo);p(Qo);p(Go);p(Ls);p(Ms);p(Eo);p(os);p(ss);p(as);p(hs);p(vs);p(Ps);p(ms);p(fs);p(ys);p(xs);p(Zs);p(ti);p(uo);p(Fs);p(ns);const oi="ja",si=`
