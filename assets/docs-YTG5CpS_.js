import{f9 as Oe,fK as re,gx as ne,fC as n,fP as le,fO as S,gy as O,gz as Pe,gA as Ce,gB as Fe,gC as je,gD as Le,gE as Me,gF as De,gG as Ue,gH as Ne,gI as He,gJ as Ve,gK as Be,gL as Ye,gM as We,gN as Ge,gO as Xe,gP as Ke,gQ as qe,gR as Ze,gS as Je,gT as Qe,gU as et,gV as tt,gW as ot,gX as st,gY as it,gZ as at,g_ as rt,g$ as nt,h0 as lt,h1 as ct,h2 as dt,h3 as pt,h4 as ut,h5 as gt,h6 as bt,h7 as ht,h8 as vt,h9 as _t,ha as mt,hb as ft,hc as yt,hd as xt,he as $t,hf as wt,hg as kt,hh as It,hi as St,hj as Et,hk as Tt,hl as zt,hm as Rt,hn as At,ho as Ot,hp as Pt,hq as Ct,hr as Ft,hs as jt,gr as me,cM as h,gw as Lt,ga as Mt,g8 as Dt,fD as q,g2 as Ut,fM as Nt,ht as Ht,gh as Vt,fX as Bt,ey as Yt,hu as ce,fQ as Wt,hv as Gt,cW as X,hw as Xt,gj as Kt,hx as qt,g1 as Zt,gv as Jt,fW as Qt,fF as eo}from"./viewport-shell-CwmS7s3G.js";function to({controller:e,open:t=!0,summaryActions:o=null,onToggle:s=null,showList:l=!0,store:c,t:i}){var te,oe;const b=c.referenceImages.assets.value,g=c.referenceImages.items.value,C=Oe(g),G=c.referenceImages.presets.value,A=c.referenceImages.previewSessionVisible.value,Ee=c.referenceImages.selectedAssetId.value,Q=c.referenceImages.selectedItemId.value,Te=new Set(c.referenceImages.selectedItemIds.value??[]),ze=c.referenceImages.panelPresetId.value,u=g.find(a=>a.id===Q)??null,ee=b.find(a=>a.id===((u==null?void 0:u.assetId)??Ee))??null,Re=(a,r,d)=>{var f,se,F,ie,j,ae;(se=(f=e())==null?void 0:f.selectReferenceImageItem)==null||se.call(f,r,{additive:a.ctrlKey||a.metaKey,toggle:a.ctrlKey||a.metaKey,range:a.shiftKey,orderedIds:d}),(ie=(F=e())==null?void 0:F.isReferenceImageSelectionActive)!=null&&ie.call(F)&&((ae=(j=e())==null?void 0:j.activateViewportReferenceImageEditModeImplicit)==null||ae.call(j))};function Ae({selected:a=!1,active:r=!1}){const d=["scene-asset-row"];return a&&d.push("scene-asset-row--selected"),r&&d.push("scene-asset-row--active"),d.join(" ")}return n`
		<${re}
			icon="image"
...
`,ue={x:{x2:"92",y2:"50"},y:{x2:"50",y2:"8"},z:{x2:"50",y2:"50"}},vo=[{key:"pos-x",cls:"positive--x",label:"X",left:"92%",top:"50%"},{key:"pos-y",cls:"positive--y",label:"Y",left:"50%",top:"8%"},{key:"pos-z",cls:"positive--z",label:"Z",left:"50%",top:"50%"},{key:"neg-x",cls:"negative--x",label:"",left:"8%",top:"50%"},{key:"neg-y",cls:"negative--y",label:"",left:"50%",top:"92%"},{key:"neg-z",cls:"negative--z",label:"",left:"50%",top:"50%"}];function _o(){return n`
	...
	`}const mo={id:"axis-gizmo",type:"viewport",title:"Viewport axis gizmo (orthographic posZ)",mount:()=>{const e=k("cf-test2-default");return n`
		...
		`}},N=800,H=560,ye=110,xe=70,Z=580,J=420,fo="rgba(255, 87, 72, 0.92)",ge="rgba(255, 182, 170, 0.98)",yo="rgba(255, 87, 72, 0.18)",xo="#ffd8d1";function V(e){return{widthPct:e*(1536/1754)*100,heightPct:e*(864/1240)*100}}const $o=`
.docs-viewport-host {
	position: relative;
	width: ${N}px;
	height: ${H}px;
...
`,wo=["top-left","top","top-right","right","bottom-right","bottom","bottom-left","left"],ko=["top","right","bottom","left"];function B({frames:e=[],anchorOffset:t={left:"50%",top:"50%"}}={}){return n`
		<div
			id="render-box"
			class="render-box is-selected"
			data-anchor-handle="center"
			style=${{left:`${ye}px`,top:`${xe}px`,width:`${Z}px`,height:`${J}px`}}
		>
			${e.map(o=>n`
					<div
						key=${o.id}
	...
	`}const Io={id:"camera-mode-render-box",type:"viewport",title:"Camera mode with render-box overlay",mount:()=>{const e=k("cf-test2-default"),{widthPct:t,heightPct:o}=V(1);return n`
			<div class="docs-viewport-host">
				...
				<img
					...
					alt=${e.description}
				/>
				${B({frames:[{id:"frame-1",label:"A",active:!0,left:`${(100-t)/2}%`,top:`${(100-o)/2}%`,width:`${t}%`,height:`${o}%`}]})}
			</div>
		`}},So=`
.docs-overlay-host {
	position: relative;
...
`,Ao={id:"drop-hint",type:"viewport",title:"Viewport drop hint (empty project)",mount:({lang:e})=>{const t=(o,s)=>h(e,o,s);return n`
			<div class="docs-viewport-host">
				<style>${Ro}</style>
				<div class="drop-hint">
		...
		`}},be="__calls",he="__methods";function m(e={}){const t=e.log===!0,o=e.methods??null,s=[],l={[be]:s,[he]:o};return new Proxy(l,{get(c,i){if(typeof i!="string")return Reflect.get(c,i);if(i===be)return s;if(i===he)return o;const b=o&&Object.hasOwn(o,i)?o[i]:null;return(...g)=>{if(s.push({method:i,args:g}),t&&console.debug(`[mock-controller] ${i}`,g),b)return b(...g)}}})}function v(e={}){const t=Lt(null);return $e(t,e,[]),t}function $e(e,t,o){for(const[s,l]of Object.entries(t)){const c=o.concat(s),i=e==null?void 0:e[s];if(i==null)throw new Error(`createMockStore: unknown path "${c.join(".")}"`);if(Oo(i)){Po(i,l,c);continue}if(ve(i)&&ve(l)){$e(i,l,c);continue}throw new Error(`createMockStore: cannot assign "${c.join(".")}" — target is neither a signal nor a namespace`)}}function Oo(e){return e!==null&&typeof e=="object"&&"value"in e&&typeof e.peek=="function"}function ve(e){if(e===null||typeof e!="object"||Array.isArray(e))return!1;const t=Object.getPrototypeOf(e);return t===Object.prototype||t===null}function Po(e,t,o){try{e.value=t}catch(s){const l=s instanceof Error?s.message:String(s);throw new Error(`createMockStore: cannot assign to "${o.join(".")}" (computed or read-only): ${l}`)}}const Co=`
.docs-section-host {
	padding: 24px;
	display: inline-block;
	background: #08111d;
...
`,Fo={id:"export-output-section",type:"panel",title:"Export Output section",size:{width:360},mount:({lang:e})=>{const t=v(),o=m();return n`
...
`,Do={id:"export-settings-section",type:"panel",title:"Export Settings section",size:{width:360},mount:({lang:e})=>{const t=v(),o=m();return n`
			<div class="docs-section-host">
				<style>${Mo}</style>
				<div class="docs-section-host__card">
					<${Dt}
...
`,No=[{icon:"plus",labelKey:"menu.newProjectAction",shortcut:"Ctrl+N"},{icon:"folder-open",labelKey:"action.openFiles",shortcut:"Ctrl+O"},{icon:"save",labelKey:"menu.saveWorkingStateAction",shortcut:"Ctrl+S"},{icon:"package",labelKey:"menu.savePackageAction",shortcut:"Ctrl+Shift+S"}];function we({lang:e,urlValue:t="",focusRing:o=!1}){const s=l=>h(e,l);return n`
	...
	`}const Ho={id:"open-menu",type:"overlay",title:"Tool Rail File menu (open)",mount:({lang:e})=>we({lang:e})},Vo={id:"remote-url-input",type:"overlay",title:"Remote URL input (focused)",mount:({lang:e})=>we({lang:e,urlValue:"https://example.com/scene.spz",focusRing:!0})},Bo=800,Yo=560,Wo=`
.docs-viewport-host {
	position: relative;
	width: ${Bo}px;
	height: ${Yo}px;
...
`,Go={id:"first-scene-loaded",type:"viewport",title:"Viewport after first scene load",mount:()=>{const e=k("cf-test2-default");return n`
			<div class="docs-viewport-host">
				<style>${Wo}</style>
				<img
					class="docs-viewport-host__backdrop"
...
`,Ko={id:"inspector-tabs",type:"panel",title:"Inspector tabs (Camera active)",mount:({lang:e})=>n`
...
`,Zo={id:"lighting-widget",type:"panel",title:"Lighting Direction widget",mount:()=>{const e=m();return n`
...
`,ns={id:"output-frame-section",type:"panel",title:"Output Frame section",size:{width:360},mount:({lang:e})=>{const t=v(),o=m();return n`
			<div class="docs-section-host">
				<style>${rs}</style>
				<div class="docs-section-host__card">
					<${Vt}
...
`;function ke({lang:e,coarse:t=!1}){const o=(c,i)=>h(e,c,i),s=Yt({mode:"camera",t:o,viewportToolMode:"select",viewportOrthographic:!1,referencePreviewSessionVisible:!0,hasReferenceImages:!1,frameMaskMode:"off"}),l=s.find(c=>c.id==="tool-select")??null;return n`
				...
				${s.map(c=>{const i=Math.cos(c.angle)*ce,b=Math.sin(c.angle)*ce,g=["viewport-pie__item",c.id===(l==null?void 0:l.id)||c.active?"viewport-pie__item--active":"",c.disabled?"viewport-pie__item--disabled":""].filter(Boolean).join(" ");return n`
						...
						>
							<span class="viewport-pie__item-icon">
								<${q} name=${c.icon} size=${18} />
							</span>
						</button>
					`})}
			</div>
		</div>
	`}const gs={id:"pie-menu",type:"overlay",title:"Viewport pie menu (open)",mount:({lang:e})=>ke({lang:e,coarse:!1})},bs={id:"pie-menu-expanded",type:"overlay",title:"Viewport pie menu (coarse / expanded)",mount:({lang:e})=>ke({lang:e,coarse:!0})},hs=800,vs=560,_s=200,ms=110,fs=400,ys=300,xs=-4,$s=`
.docs-viewport-host {
	position: relative;
	width: ${hs}px;
	height: ${vs}px;
...
`,ws=["top","right","bottom","left"],ks=["top-left","top","top-right","right","bottom-right","bottom","bottom-left","left"],Is=["top-left","top","top-right","right","bottom-right","bottom","bottom-left","left"],Ss={id:"reference-edit-mode",type:"viewport",title:"Reference image edit mode",mount:()=>{const e=k("cf-test2-default"),t={left:`${_s}px`,top:`${ms}px`,width:`${fs}px`,height:`${ys}px`,transform:`rotate(${xs}deg)`,transformOrigin:"50% 50%"};return n`
			<div class="docs-viewport-host">
				<style>${$s}</style>
				<img
					class="docs-viewport-host__backdrop"
...
`;function P({id:e,kind:t,label:o,visible:s=!0}){return{id:e,kind:t,label:o,visible:s}}const Ps={id:"scene-manager",type:"panel",title:"Scene Manager (kind-grouped asset list)",size:{width:360},mount:({lang:e})=>{const t=[P({id:1,kind:"model",label:"Environment.glb"}),P({id:2,kind:"model",label:"Figure.glb"}),P({id:3,kind:"splat",label:"MainScan.ply"}),P({id:4,kind:"splat",label:"Foreground.spz",visible:!1}),P({id:5,kind:"splat",label:"Background.ply"})],o=t[2],s=v({selectedSceneAssetIds:[o.id],selectedSceneAssetId:o.id}),l=m();return n`
			<div class="docs-section-host">
				<style>${Os}</style>
				<div class="docs-section-host__card">
					<${Wt}
...
`,Fs={id:"section-display-zoom",type:"panel",title:"Display Zoom section",size:{width:360},mount:({lang:e})=>{const t=v(),o=m();return n`
			<div class="docs-section-host">
				<style>${Cs}</style>
				<div class="docs-section-host__card">
					<${Gt}
...
`,Ds={id:"shot-camera-properties",type:"panel",title:"Shot Camera Properties section",size:{width:360},mount:({lang:e})=>{const t=v({shotCamera:{positionX:1.23,positionY:2.45,positionZ:-.5,yawDeg:45,pitchDeg:-15,rollDeg:0}}),o=m();return n`
			<div class="docs-section-host">
				<style>${Ms}</style>
				<div class="docs-section-host__card">
					<${Kt}
...
`;function Y(e,t){const o=m();return n`
	...
	`}const Ns={id:"splat-edit-toolbar",type:"overlay",title:"Splat edit toolbar (box tool, unplaced)",mount:({lang:e})=>{const t=v({viewportToolMode:"splat-edit"});return Y(t,e)}},Hs={id:"per-splat-brush-preview",type:"overlay",title:"Splat edit toolbar (brush tool)",mount:({lang:e})=>{const t=v({viewportToolMode:"splat-edit",splatEdit:{tool:"brush",brushSize:30,brushDepthMode:"depth",brushDepth:.2}});return Y(t,e)}},Vs={id:"per-splat-box-tool",type:"overlay",title:"Splat edit toolbar (box tool, placed)",mount:({lang:e})=>{const t=v({viewportToolMode:"splat-edit",splatEdit:{tool:"box",boxPlaced:!0,boxCenter:{x:.5,y:1.2,z:-.3},boxSize:{x:1,y:.6,z:1.4},boxRotation:{x:0,y:0,z:0,w:1},selectionCount:12345}});return Y(t,e)}},Bs={id:"per-splat-edit-toolbar",type:"overlay",title:"Splat edit toolbar (annotated)",annotations:[{n:1,selector:".viewport-splat-edit-toolbar__bar > .viewport-splat-edit-toolbar__group:nth-of-type(1)",label:"Tool 選択"},{n:2,selector:".viewport-splat-edit-toolbar__bar > .viewport-splat-edit-toolbar__group:nth-of-type(3)",label:"選択操作"},{n:3,selector:".viewport-splat-edit-toolbar__bar > .viewport-splat-edit-toolbar__group:nth-of-type(5)",label:"編集アクション"},{n:4,selector:".viewport-splat-edit-toolbar__bar > .viewport-splat-edit-toolbar__info",label:"選択数"}],mount:({lang:e})=>{const t=v({viewportToolMode:"splat-edit",splatEdit:{tool:"box",selectionCount:42}});return Y(t,e)}},Ys=`
.docs-rail-host {
	padding: 24px;
	display: inline-block;
	background: #08111d;
...
`,Ws={id:"tool-rail",type:"panel",title:"Viewport tool rail",mount:({lang:e})=>{const t=v(),o=m(),s=(l,c)=>h(e,l,c);return n`
...
`,I=[{id:"frame-1",label:"FRAME A",center:{x:.3933,y:.5404},scale:1,active:!1,tangent:{in:{x:-.0874,y:.0026},out:{x:.0874,y:-.0026}}},{id:"frame-2",label:"FRAME B",center:{x:.6461,y:.4232},scale:.8549,active:!0,tangent:{in:{x:-.077,y:.0809},out:{x:.077,y:-.0809}}}];function Se(e,t){return{x:ye+Z*e,y:xe+J*t}}function Xs(e){const{widthPct:t,heightPct:o}=V(e.scale);return{id:e.id,label:e.label,active:e.active,left:e.center.x*100-t/2,top:e.center.y*100-o/2,width:t,height:o}}const Ks=I.map(Xs),$=Se(I[0].center.x,I[0].center.y),w=Se(I[1].center.x,I[1].center.y);function W(e,t){return{x:e.x+t.x*Z,y:e.y+t.y*J}}const L=W($,I[0].tangent.in),E=W($,I[0].tangent.out),T=W(w,I[1].tangent.in),M=W(w,I[1].tangent.out);function qs(e){return{id:e.id,label:e.label,active:e.active,left:`${e.left}%`,top:`${e.top}%`,width:`${e.width}%`,height:`${e.height}%`}}const Zs={id:"trajectory-spline",type:"viewport",title:"Camera mode with spline trajectory (cf-test2 Camera 3)",mount:()=>{const e=k("cf-test2-default");return n`
			<div class="docs-viewport-host">
				<style>${Gs}</style>
				<img
					class="docs-viewport-host__backdrop"
...
`,ti={id:"transform-gizmo",type:"viewport",title:"Transform gizmo over selected asset",mount:()=>{const e=k("cf-test2-default"),t={x:y+z*.95,y:x+z*.15},o={x:y-z*.1,y:x-z*.98},s={x:y+z*.5,y:x+z*.75};return n`
		...
		`}};p(Fs);p(Ds);p(Ls);p(ns);p(Do);p(Fo);p(Lo);p(Ao);p(Go);p(mo);p(Ws);p(Io);p(as);p(As);p(ts);p(Ts);p(zs);p(Eo);p(Ho);p(Vo);p(Ko);p(gs);p(bs);p(Ss);p(Ns);p(Hs);p(Vs);p(Bs);p(Zs);p(ti);p(uo);p(Ps);p(Zo);const oi="ja",si=`
