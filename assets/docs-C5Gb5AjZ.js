import{f3 as Ce,fB as ie,go as ae,ft as n,fG as re,fF as I,gp as R,gq as Pe,gr as Ae,gs as Fe,gt as Oe,gu as je,gv as Le,gw as Me,gx as De,gy as Ue,gz as He,gA as Ve,gB as Ne,gC as Ye,gD as Be,gE as We,gF as Ge,gG as Xe,gH as Ke,gI as Ze,gJ as qe,gK as Je,gL as Qe,gM as et,gN as tt,gO as ot,gP as st,gQ as it,gR as at,gS as rt,gT as nt,gU as lt,gV as ct,gW as dt,gX as pt,gY as ut,gZ as gt,g_ as bt,g$ as vt,h0 as ht,h1 as _t,h2 as mt,h3 as ft,h4 as yt,h5 as xt,h6 as $t,h7 as wt,h8 as kt,h9 as It,ha as St,hb as Et,hc as Tt,hd as zt,he as Rt,hf as Ct,hg as Pt,hh as At,hi as Ft,hj as Ot,gi as he,cY as b,gn as jt,g1 as Lt,f$ as Mt,hk as Dt,fu as G,fV as Ut,fD as Ht,g8 as Vt,fO as Nt,et as Yt,hl as ne,hm as Bt,fH as Wt,hn as Gt,d5 as B,ho as Xt,ga as Kt,fU as Zt,gm as qt,fN as Jt,fw as Qt}from"./viewport-shell-C-aS5HDy.js";function eo({controller:e,open:t=!0,summaryActions:o=null,onToggle:s=null,showList:l=!0,store:c,t:a}){var Q,ee;const h=c.referenceImages.assets.value,g=c.referenceImages.items.value,Z=Ce(g),Ie=c.referenceImages.presets.value,Y=c.referenceImages.previewSessionVisible.value,Se=c.referenceImages.selectedAssetId.value,q=c.referenceImages.selectedItemId.value,Ee=new Set(c.referenceImages.selectedItemIds.value??[]),Te=c.referenceImages.panelPresetId.value,u=g.find(i=>i.id===q)??null,J=h.find(i=>i.id===((u==null?void 0:u.assetId)??Se))??null,ze=(i,r,d)=>{var m,te,P,oe,A,se;(te=(m=e())==null?void 0:m.selectReferenceImageItem)==null||te.call(m,r,{additive:i.ctrlKey||i.metaKey,toggle:i.ctrlKey||i.metaKey,range:i.shiftKey,orderedIds:d}),(oe=(P=e())==null?void 0:P.isReferenceImageSelectionActive)!=null&&oe.call(P)&&((se=(A=e())==null?void 0:A.activateViewportReferenceImageEditModeImplicit)==null||se.call(A))};function Re({selected:i=!1,active:r=!1}){const d=["scene-asset-row"];return i&&d.push("scene-asset-row--selected"),r&&d.push("scene-asset-row--active"),d.join(" ")}return n`
		<${ie}
			icon="image"
...
`;function oo(){const t=Object.entries(Object.assign({"../../ui/svg/apply-transform.svg":Ot,"../../ui/svg/camera-dslr.svg":Ft,"../../ui/svg/camera-frames.svg":At,"../../ui/svg/camera-property.svg":Pt,"../../ui/svg/camera.svg":Ct,"../../ui/svg/chevron-left.svg":Rt,"../../ui/svg/chevron-right.svg":zt,"../../ui/svg/clock.svg":Tt,"../../ui/svg/close.svg":Et,"../../ui/svg/copy-to-camera.svg":St,"../../ui/svg/copy-to-viewport.svg":It,"../../ui/svg/cursor.svg":kt,"../../ui/svg/duplicate.svg":wt,"../../ui/svg/export-tab.svg":$t,"../../ui/svg/export.svg":xt,"../../ui/svg/eye-off.svg":yt,"../../ui/svg/eye.svg":ft,"../../ui/svg/folder-open.svg":mt,"../../ui/svg/frame-plus.svg":_t,"../../ui/svg/frame.svg":ht,"../../ui/svg/grip.svg":vt,"../../ui/svg/help.svg":bt,"../../ui/svg/image.svg":gt,"../../ui/svg/lens.svg":ut,"../../ui/svg/light.svg":pt,"../../ui/svg/link.svg":dt,"../../ui/svg/lock-open.svg":ct,"../../ui/svg/lock.svg":lt,"../../ui/svg/mask-all.svg":nt,"../../ui/svg/mask-selected.svg":rt,"../../ui/svg/mask.svg":at,"../../ui/svg/menu.svg":it,"../../ui/svg/move.svg":st,"../../ui/svg/package-open.svg":ot,"../../ui/svg/package.svg":tt,"../../ui/svg/pie-menu.svg":et,"../../ui/svg/pin.svg":Qe,"../../ui/svg/pivot.svg":Je,"../../ui/svg/plus.svg":qe,"../../ui/svg/redo.svg":Ze,"../../ui/svg/reference-preview-off.svg":Ke,"../../ui/svg/reference-preview-on.svg":Xe,"../../ui/svg/reference-tool.svg":Ge,"../../ui/svg/reference.svg":We,"../../ui/svg/render-box.svg":Be,"../../ui/svg/reset.svg":Ye,"../../ui/svg/ruler.svg":Ne,"../../ui/svg/save.svg":Ve,"../../ui/svg/scene.svg":He,"../../ui/svg/scrub.svg":Ue,"../../ui/svg/selection-clear.svg":De,"../../ui/svg/settings.svg":Me,"../../ui/svg/slash-circle.svg":Le,"../../ui/svg/trash.svg":je,"../../ui/svg/undo.svg":Oe,"../../ui/svg/view.svg":Fe,"../../ui/svg/viewport.svg":Ae,"../../ui/svg/zoom.svg":Pe})).map(([o,s])=>{const l=o.match(/\/([^/]+)\.svg$/i),c=l?l[1]:null;return c&&typeof s=="string"?{name:c,rawSvg:s}:null}).filter(Boolean);return t.sort((o,s)=>o.name.localeCompare(s.name)),t}const ce={id:"icons-all",type:"reference",title:"All workbench icons",mount:({lang:e})=>{const t=oo();return n`
		...
		`}},L={[le.id]:le,[ce.id]:ce};function p(e){if(!e||typeof e.id!="string"||e.id.length===0)throw new Error("registerFixture: fixture.id must be a non-empty string");if(Object.hasOwn(L,e.id))throw new Error(`registerFixture: duplicate id "${e.id}"`);L[e.id]=e}function so(e){return typeof e!="string"||e===""?null:L[e]??null}function _e(){return Object.keys(L)}const io={"cf-test2-default":{id:"cf-test2-default",backdropUrl:"/docs/help/assets/fixture-backdrops/cf-test2-default.png",width:1073,height:1264,description:"cf-test2 の仮のシーン（権利クリア済みの motorbike スプラット）"}};function w(e){const t=io[e];if(!t)throw new Error(`makeScene: unknown scene "${e}"`);return t}const ao=960,ro=600,no=`
.docs-layout-host {
	position: relative;
	width: ${ao}px;
	height: ${ro}px;
...
`,lo=[{active:!1},{active:!1},{active:!1},{active:!1},{active:!0},{active:!1},{active:!1},{active:!1},{active:!1},{active:!1}],co={id:"app-layout-overview",type:"composite",title:"Full app layout overview",annotations:[{n:1,selector:".docs-layout-host__viewport",label:"Viewport"},{n:2,selector:".workbench-card--tool-rail",label:"Tool Rail"},{n:3,selector:".workbench-card--inspector",label:"Inspector"},{n:4,selector:".viewport-project-status",label:"Project Status HUD"}],mount:()=>{const e=w("cf-test2-default");return n`
...
`,de={x:{x2:"92",y2:"50"},y:{x2:"50",y2:"8"},z:{x2:"50",y2:"50"}},bo=[{key:"pos-x",cls:"positive--x",label:"X",left:"92%",top:"50%"},{key:"pos-y",cls:"positive--y",label:"Y",left:"50%",top:"8%"},{key:"pos-z",cls:"positive--z",label:"Z",left:"50%",top:"50%"},{key:"neg-x",cls:"negative--x",label:"",left:"8%",top:"50%"},{key:"neg-y",cls:"negative--y",label:"",left:"50%",top:"92%"},{key:"neg-z",cls:"negative--z",label:"",left:"50%",top:"50%"}];function vo(){return n`
	...
	`}const ho={id:"axis-gizmo",type:"viewport",title:"Viewport axis gizmo (orthographic posZ)",mount:()=>{const e=w("cf-test2-default");return n`
		...
		`}},M=800,D=560,me=110,fe=70,X=580,K=420,_o="rgba(255, 87, 72, 0.92)",pe="rgba(255, 182, 170, 0.98)",mo="rgba(255, 87, 72, 0.18)",fo="#ffd8d1";function U(e){return{widthPct:e*(1536/1754)*100,heightPct:e*(864/1240)*100}}const yo=`
.docs-viewport-host {
	position: relative;
	width: ${M}px;
	height: ${D}px;
...
`,xo=["top-left","top","top-right","right","bottom-right","bottom","bottom-left","left"],$o=["top","right","bottom","left"];function H({frames:e=[],anchorOffset:t={left:"50%",top:"50%"}}={}){return n`
		<div
			id="render-box"
		...
		>
			${e.map(o=>n`
					<div
						...
						style=${{left:o.left,top:o.top,width:o.width,height:o.height,border:`2px solid ${_o}`,boxSizing:"border-box",background:"transparent",boxShadow:o.active?`inset 0 0 0 1px ${pe}`:"none"}}
					>
						${o.active&&n`
							<span
								aria-hidden="true"
						...
						`}
						<span
							style=${{position:"absolute",top:"-22px",left:"0",padding:"2px 9px",borderRadius:"999px",background:mo,color:fo,fontFamily:'"Consolas", "Andale Mono", monospace',fontSize:"11px",fontWeight:600,letterSpacing:"0.05em",textTransform:"uppercase",whiteSpace:"nowrap"}}
						>
							${o.label}
						</span>
					</div>
	...
	`}const wo={id:"camera-mode-render-box",type:"viewport",title:"Camera mode with render-box overlay",mount:()=>{const e=w("cf-test2-default"),{widthPct:t,heightPct:o}=U(1);return n`
			<div class="docs-viewport-host">
				<style>${yo}</style>
				<img
					class="docs-viewport-host__backdrop"
...
`,Io={id:"confirm-new-project",type:"overlay",title:"Confirm: New Project",mount:()=>n`
			<div class="docs-overlay-host">
				<style>${ko}</style>
				<${he} overlay=${{kind:"confirm",title:"新規プロジェクトを作成しますか？",message:"現在の作業は未保存の変更を含みます。新規プロジェクトを作成すると現在の作業は破棄されます。",actions:[{label:"キャンセル",onClick:()=>{}},{label:"破棄して新規作成",primary:!0,onClick:()=>{}}]}} />
			</div>
		`},So=800,Eo=560,To=`
.docs-viewport-host {
	position: relative;
...
`,zo={id:"drop-hint",type:"viewport",title:"Viewport drop hint (empty project)",mount:({lang:e})=>{const t=(o,s)=>b(e,o,s);return n`
			<div class="docs-viewport-host">
				<style>${To}</style>
				<div class="drop-hint">
		...
		`}},ue="__calls",ge="__methods";function _(e={}){const t=e.log===!0,o=e.methods??null,s=[],l={[ue]:s,[ge]:o};return new Proxy(l,{get(c,a){if(typeof a!="string")return Reflect.get(c,a);if(a===ue)return s;if(a===ge)return o;const h=o&&Object.hasOwn(o,a)?o[a]:null;return(...g)=>{if(s.push({method:a,args:g}),t&&console.debug(`[mock-controller] ${a}`,g),h)return h(...g)}}})}function v(e={}){const t=jt(null);return ye(t,e,[]),t}function ye(e,t,o){for(const[s,l]of Object.entries(t)){const c=o.concat(s),a=e==null?void 0:e[s];if(a==null)throw new Error(`createMockStore: unknown path "${c.join(".")}"`);if(Ro(a)){Co(a,l,c);continue}if(be(a)&&be(l)){ye(a,l,c);continue}throw new Error(`createMockStore: cannot assign "${c.join(".")}" — target is neither a signal nor a namespace`)}}function Ro(e){return e!==null&&typeof e=="object"&&"value"in e&&typeof e.peek=="function"}function be(e){if(e===null||typeof e!="object"||Array.isArray(e))return!1;const t=Object.getPrototypeOf(e);return t===Object.prototype||t===null}function Co(e,t,o){try{e.value=t}catch(s){const l=s instanceof Error?s.message:String(s);throw new Error(`createMockStore: cannot assign to "${o.join(".")}" (computed or read-only): ${l}`)}}const Po=`
.docs-section-host {
	padding: 24px;
	display: inline-block;
	background: #08111d;
...
`,Ao={id:"export-output-section",type:"panel",title:"Export Output section",size:{width:360},mount:({lang:e})=>{const t=v(),o=_();return n`
...
`,Lo={id:"export-settings-section",type:"panel",title:"Export Settings section",size:{width:360},mount:({lang:e})=>{const t=v(),o=_();return n`
			<div class="docs-section-host">
				<style>${jo}</style>
				<div class="docs-section-host__card">
					<${Mt}
...
`,Ho={id:"first-scene-loaded",type:"viewport",title:"Viewport after first scene load",mount:()=>{const e=w("cf-test2-default");return n`
			<div class="docs-viewport-host">
				<style>${Uo}</style>
				<img
					class="docs-viewport-host__backdrop"
...
`,Go=[{id:"frame-1",label:"FRAME A",center:{x:.5,y:.5},scale:1,active:!1},{id:"frame-2",label:"FRAME B",center:{x:.5755,y:.5169},scale:.5537,active:!0}];function Xo(e){const{widthPct:t,heightPct:o}=U(e.scale);return{id:e.id,label:e.label,active:e.active,left:`${e.center.x*100-t/2}%`,top:`${e.center.y*100-o/2}%`,width:`${t}%`,height:`${o}%`}}const Ko={id:"multiple-frames",type:"viewport",title:"Camera mode with multiple frames (zoom-in / TU)",mount:()=>{const e=w("cf-test2-default");return n`
			<div class="docs-viewport-host">
				<style>${Wo}</style>
				<img
					class="docs-viewport-host__backdrop"
...
`,qo={id:"render-box-camera-mode",type:"viewport",title:"Render-box in camera mode (annotated)",annotations:[{n:1,selector:".render-box__resize-handle--top-right",label:"リサイズハンドル（8 方向）"},{n:2,selector:".render-box__pan-edge--top",label:"パンエッジ（4 辺）"},{n:3,selector:"#anchor-dot",label:"anchor dot"},{n:4,selector:"#render-box-meta",label:"meta ラベル"}],mount:()=>{const e=w("cf-test2-default"),{widthPct:t,heightPct:o}=U(1);return n`
			<div class="docs-viewport-host">
				<style>${Zo}</style>
				<img
					class="docs-viewport-host__backdrop"
...
`,Qo=[{icon:"plus",labelKey:"menu.newProjectAction",shortcut:"Ctrl+N"},{icon:"folder-open",labelKey:"action.openFiles",shortcut:"Ctrl+O"},{icon:"save",labelKey:"menu.saveWorkingStateAction",shortcut:"Ctrl+S"},{icon:"package",labelKey:"menu.savePackageAction",shortcut:"Ctrl+Shift+S"}];function xe({lang:e,urlValue:t="",focusRing:o=!1}){const s=l=>b(e,l);return n`
	...
	`}const es={id:"open-menu",type:"overlay",title:"Tool Rail File menu (open)",mount:({lang:e})=>xe({lang:e})},ts={id:"remote-url-input",type:"overlay",title:"Remote URL input (focused)",mount:({lang:e})=>xe({lang:e,urlValue:"https://example.com/scene.spz",focusRing:!0})},os=`
.docs-tabs-host {
	padding: 24px;
	display: inline-block;
	background: #08111d;
...
`,ss={id:"inspector-tabs",type:"panel",title:"Inspector tabs (Camera active)",mount:({lang:e})=>n`
...
`,as={id:"lighting-widget",type:"panel",title:"Lighting Direction widget",mount:()=>{const e=_();return n`
...
`,ns={id:"output-frame-section",type:"panel",title:"Output Frame section",size:{width:360},mount:({lang:e})=>{const t=v(),o=_();return n`
			<div class="docs-section-host">
				<style>${rs}</style>
				<div class="docs-section-host__card">
					<${Vt}
...
`;function $e({lang:e,coarse:t=!1}){const o=(c,a)=>b(e,c,a),s=Yt({mode:"camera",t:o,viewportToolMode:"select",viewportOrthographic:!1,referencePreviewSessionVisible:!0,hasReferenceImages:!1,frameMaskMode:"off"}),l=s.find(c=>c.id==="tool-select")??null;return n`
		<div class="docs-pie-host">
			...
			>
				...
				${s.map(c=>{const a=Math.cos(c.angle)*ne,h=Math.sin(c.angle)*ne,g=["viewport-pie__item",c.id===(l==null?void 0:l.id)||c.active?"viewport-pie__item--active":"",c.disabled?"viewport-pie__item--disabled":""].filter(Boolean).join(" ");return n`
						<button
							key=${c.id}
							type="button"
							class=${g}
	...
	`}const gs={id:"pie-menu",type:"overlay",title:"Viewport pie menu (open)",mount:({lang:e})=>$e({lang:e,coarse:!1})},bs={id:"pie-menu-expanded",type:"overlay",title:"Viewport pie menu (coarse / expanded)",mount:({lang:e})=>$e({lang:e,coarse:!0})},vs=`
...
`;function V(e,t){const o=_();return n`
	...
	`}const hs={id:"splat-edit-toolbar",type:"overlay",title:"Splat edit toolbar (box tool, unplaced)",mount:({lang:e})=>{const t=v({viewportToolMode:"splat-edit"});return V(t,e)}},_s={id:"per-splat-brush-preview",type:"overlay",title:"Splat edit toolbar (brush tool)",mount:({lang:e})=>{const t=v({viewportToolMode:"splat-edit",splatEdit:{tool:"brush",brushSize:30,brushDepthMode:"depth",brushDepth:.2}});return V(t,e)}},ms={id:"per-splat-box-tool",type:"overlay",title:"Splat edit toolbar (box tool, placed)",mount:({lang:e})=>{const t=v({viewportToolMode:"splat-edit",splatEdit:{tool:"box",boxPlaced:!0,boxCenter:{x:.5,y:1.2,z:-.3},boxSize:{x:1,y:.6,z:1.4},boxRotation:{x:0,y:0,z:0,w:1},selectionCount:12345}});return V(t,e)}},fs={id:"per-splat-edit-toolbar",type:"overlay",title:"Splat edit toolbar (annotated)",annotations:[{n:1,selector:".viewport-splat-edit-toolbar__bar > .viewport-splat-edit-toolbar__group:nth-of-type(1)",label:"Tool 選択"},{n:2,selector:".viewport-splat-edit-toolbar__bar > .viewport-splat-edit-toolbar__group:nth-of-type(3)",label:"選択操作"},{n:3,selector:".viewport-splat-edit-toolbar__bar > .viewport-splat-edit-toolbar__group:nth-of-type(5)",label:"編集アクション"},{n:4,selector:".viewport-splat-edit-toolbar__bar > .viewport-splat-edit-toolbar__info",label:"選択数"}],mount:({lang:e})=>{const t=v({viewportToolMode:"splat-edit",splatEdit:{tool:"box",selectionCount:42}});return V(t,e)}},ys=800,xs=560,$s=200,ws=110,ks=400,Is=300,Ss=-4,Es=`
.docs-viewport-host {
	position: relative;
	width: ${ys}px;
	height: ${xs}px;
...
`,Ts=["top","right","bottom","left"],zs=["top-left","top","top-right","right","bottom-right","bottom","bottom-left","left"],Rs=["top-left","top","top-right","right","bottom-right","bottom","bottom-left","left"],Cs={id:"reference-edit-mode",type:"viewport",title:"Reference image edit mode",mount:()=>{const e=w("cf-test2-default"),t={left:`${$s}px`,top:`${ws}px`,width:`${ks}px`,height:`${Is}px`,transform:`rotate(${Ss}deg)`,transformOrigin:"50% 50%"};return n`
			<div class="docs-viewport-host">
				<style>${Es}</style>
				<img
					class="docs-viewport-host__backdrop"
...
`;function C({id:e,kind:t,label:o,visible:s=!0}){return{id:e,kind:t,label:o,visible:s}}const As={id:"scene-manager",type:"panel",title:"Scene Manager (kind-grouped asset list)",size:{width:360},mount:({lang:e})=>{const t=[C({id:1,kind:"model",label:"Environment.glb"}),C({id:2,kind:"model",label:"Figure.glb"}),C({id:3,kind:"splat",label:"MainScan.ply"}),C({id:4,kind:"splat",label:"Foreground.spz",visible:!1}),C({id:5,kind:"splat",label:"Background.ply"})],o=t[2],s=v({selectedSceneAssetIds:[o.id],selectedSceneAssetId:o.id}),l=_();return n`
			<div class="docs-section-host">
				<style>${Ps}</style>
				<div class="docs-section-host__card">
					<${Wt}
...
`;function j(e,t){return{id:e,name:t,itemRefs:[]}}function W({id:e,name:t,fileName:o,group:s,order:l}){return{id:e,assetId:`asset-${e}`,name:t,fileName:o,group:s,order:l,previewVisible:!0,exportEnabled:!0,opacity:1,scalePct:100,rotationDeg:0,offsetPx:{x:0,y:0},anchor:{ax:.5,ay:.5}}}function we(e,t){const o=_();return n`
		<div class="docs-section-host">
			<style>${Fs}</style>
			<div class="docs-section-host__card">
				<${eo}
	...
	`}const Os={id:"reference-presets",type:"panel",title:"Reference Presets row",size:{width:360},mount:({lang:e})=>{const t=v({referenceImages:{presets:[j("reference-preset-blank","(blank)"),j("reference-preset-outdoor","屋外ロケハン"),j("reference-preset-storyboard","コンテ A")],panelPresetId:"reference-preset-outdoor",items:[]}});return we(t,e)}},js={id:"reference-manager",type:"panel",title:"Reference Manager list",size:{width:360},mount:({lang:e})=>{const t=v({referenceImages:{presets:[j("reference-preset-blank","(blank)")],panelPresetId:"reference-preset-blank",items:[W({id:"ref-1",name:"Layout",fileName:"layout.png",group:"front",order:0}),W({id:"ref-2",name:"Rough Sketch",fileName:"rough.png",group:"back",order:1}),W({id:"ref-3",name:"Pose Reference",fileName:"pose-reference.jpg",group:"front",order:2})]}});return we(t,e)}},Ls=`
.docs-section-host {
	padding: 24px;
	display: inline-block;
	background: #08111d;
...
`,Ms={id:"section-display-zoom",type:"panel",title:"Display Zoom section",size:{width:360},mount:({lang:e})=>{const t=v(),o=_();return n`
			<div class="docs-section-host">
				<style>${Ls}</style>
				<div class="docs-section-host__card">
					<${Gt}
...
`,Vs={id:"shot-camera-properties",type:"panel",title:"Shot Camera Properties section",size:{width:360},mount:({lang:e})=>{const t=v({shotCamera:{positionX:1.23,positionY:2.45,positionZ:-.5,yawDeg:45,pitchDeg:-15,rollDeg:0}}),o=_();return n`
			<div class="docs-section-host">
				<style>${Hs}</style>
				<div class="docs-section-host__card">
					<${Kt}
...
`,Ys={id:"tool-rail",type:"panel",title:"Viewport tool rail",mount:({lang:e})=>{const t=v(),o=_(),s=(l,c)=>b(e,l,c);return n`
...
`,k=[{id:"frame-1",label:"FRAME A",center:{x:.3933,y:.5404},scale:1,active:!1,tangent:{in:{x:-.0874,y:.0026},out:{x:.0874,y:-.0026}}},{id:"frame-2",label:"FRAME B",center:{x:.6461,y:.4232},scale:.8549,active:!0,tangent:{in:{x:-.077,y:.0809},out:{x:.077,y:-.0809}}}];function ke(e,t){return{x:me+X*e,y:fe+K*t}}function Ws(e){const{widthPct:t,heightPct:o}=U(e.scale);return{id:e.id,label:e.label,active:e.active,left:e.center.x*100-t/2,top:e.center.y*100-o/2,width:t,height:o}}const Gs=k.map(Ws),x=ke(k[0].center.x,k[0].center.y),$=ke(k[1].center.x,k[1].center.y);function N(e,t){return{x:e.x+t.x*X,y:e.y+t.y*K}}const F=N(x,k[0].tangent.in),S=N(x,k[0].tangent.out),E=N($,k[1].tangent.in),O=N($,k[1].tangent.out);function Xs(e){return{id:e.id,label:e.label,active:e.active,left:`${e.left}%`,top:`${e.top}%`,width:`${e.width}%`,height:`${e.height}%`}}const Ks={id:"trajectory-spline",type:"viewport",title:"Camera mode with spline trajectory (cf-test2 Camera 3)",mount:()=>{const e=w("cf-test2-default");return n`
			<div class="docs-viewport-host">
				<style>${Bs}</style>
				<img
					class="docs-viewport-host__backdrop"
		...
		`}},Zs=800,qs=560,f=400,y=310,T=70,z=90,Js=`
.docs-viewport-host {
	position: relative;
	width: ${Zs}px;
	height: ${qs}px;
...
`,Qs={id:"transform-gizmo",type:"viewport",title:"Transform gizmo over selected asset",mount:()=>{const e=w("cf-test2-default"),t={x:f+T*.95,y:y+T*.15},o={x:f-T*.1,y:y-T*.98},s={x:f+T*.5,y:y+T*.75};return n`
			<div class="docs-viewport-host">
				<style>${Js}</style>
				<img
					class="docs-viewport-host__backdrop"
		...
		`}};p(Ms);p(Vs);p(Us);p(ns);p(Lo);p(Ao);p(Oo);p(zo);p(Ho);p(ho);p(Ys);p(wo);p(Ko);p(qo);p(Bo);p(Os);p(js);p(Io);p(es);p(ts);p(ss);p(gs);p(bs);p(Cs);p(hs);p(_s);p(ms);p(fs);p(Ks);p(Qs);p(co);p(As);p(as);const ei="ja",ti=`
...
`;function oi({fixtureId:e,available:t}){return n`
	...
	`}function ii({fixtureId:e,lang:t}){const o=so(e);if(!o)return n`<${oi}
			fixtureId=${e}
			available=${_e()}
		...
		>
			<style>${ti}</style>
			${o.mount({lang:t})}
			${s.length>0&&n`<${si} annotations=${s}/>`}
		</div>
	`}function ve(e,t){try{const o=new URL(globalThis.location.href).searchParams.get(e);return o===null?t:o}catch{return t}}function ai(e){let t=!1;const o=()=>{t||(t=!0,globalThis.__DOCS_FIXTURE_READY=!0,globalThis.__DOCS_FIXTURE_ID=e)};requestAnimationFrame(()=>{requestAnimationFrame(o)}),setTimeout(o,100)}function ri(){const e=document.getElementById("docs-root");if(!e)return;const t=ve("fixture",""),o=ve("lang",ei);globalThis.__DOCS_FIXTURE_READY=!1,globalThis.__DOCS_FIXTURE_ID=t,globalThis.__DOCS_FIXTURE_IDS=_e(),qt(n`<${ii} fixtureId=${t} lang=${o} />`,e),ai(t)}ri();
