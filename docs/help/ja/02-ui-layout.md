...
用紙枠 内に配置される矩形。複数配置でき、選択・移動・回転・リサイズ・アンカー 編集に対応します。軌道（軌道）モードでは frame center を繋ぐ path を編集できます。
...
![スプラット編集 toolbar](../assets/screenshots/ja/スプラット-edit-toolbar.png)
