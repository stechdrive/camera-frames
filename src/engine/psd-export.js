		...
		...(layer.mask
			? {
					mask: {
						...
						right:
							layer.mask.right ?? layer.mask.left + layer.mask.canvas.width,
						bottom:
							layer.mask.bottom ?? layer.mask.top + layer.mask.canvas.height,
	...
	const psdBuffer = writePsd(
		{
			...
			children: layers.map((layer) => toPsdLayer(layer)),
		},
		{ compress: false },
	);
