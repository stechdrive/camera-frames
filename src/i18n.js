...
const MESSAGES = {
	ja: {
		app: {
			previewTag: "Spark 2.1",
			panelCopy: "Spark 2.1 を基盤にした CAMERA_FRAMES のワークフロー。",
		},
		field: {
			language: "Language",
			remoteUrl: "リモート URL",
		...
		timeline: {
			...
			keyTarget: "キー対象",
			keyTargetCamera: "カメラ",
			keyTargetSelectedObjects: "選択Obj",
			keyTargetBoth: "両方",
			keyTargetNoObjects: "未選択",
			keyTargetObjects: "{count} オブジェクト",
			targetTypeCamera: "CAM",
			targetTypeMesh: "MESH",
			targetTypeSplat: "SPLAT",
			addKey: "キーを追加",
			copyKeys: "選択キーをコピー",
			pasteKeys: "現在フレームへ貼り付け",
			deleteKeys: "選択キーを削除",
			currentFrameKeyed: "キーあり",
			currentFrameNoKey: "キーなし",
			interpolation: "補間",
		...
		action: {
			...
			openFiles: "開く...",
			resetFrameTrajectoryNodeAuto: "ノードを自動に戻す",
			...
			close: "閉じる",
			closeWorkspacePane: "{name}を閉じる",
			showDualWorkspace: "カメラビューとビューポートを2画面表示",
			continueSave: "保存する",
			continueLoad: "読み込む",
			showAsset: "表示",
			hideAsset: "非表示",
			...
			undo: "元に戻す",
			redo: "やり直す",
			duplicateSelectedSceneAssets: "選択中のオブジェクトを複製",
		...
		overlay: {
			...
			importDetailLoadAssetStage: "{index}/{count} アセット: {name} - {stage}",
			importTimingStage: "工程",
			importTimingTotal: "合計",
			importLoadStage: {
				materialize: "パッケージ resource を展開中",
				readBytes: "ファイル bytes を読込中",
				decodeSource: "3DGS データ変換中",
				prepareRawPackedSplat: "raw 3DGS arrays / LoD arrays 準備中",
				initLod: "焼込み済み LoD を初期化中",
				initPackedSplats: "Spark PackedSplats 初期化中",
				buildBounds: "bounds を計算中",
				initSplatMesh: "GPU メッシュを準備中",
				registerScene: "シーンへ登録中",
				loadModel: "3D model を読込中",
			},
		...
		status: {
			...
			dualWorkspaceEnabled: "カメラビューとビューポートを2画面表示しました。",
			workspacePaneClosed: "{name}を閉じました。",
			...
			splatEditDuplicate: "複製",
			splatEditSelectAll: "全選択",
			splatEditInvert: "反転",
			splatEditLodStale: "LoD 最適化",
			splatEditLodReady: "LoD 最適化済み",
			splatEditLodRunning: "LoD 最適化中…",
			splatEditLodTooltip:
				"描画用の LoD を再構築します。スプラット編集すると自動で無効になるため、適宜押して軽く保ちます。",
			...
			duplicatedSceneAsset: "{name} を複製しました。",
			duplicatedSceneAssets: "{count} 件のオブジェクトを複製しました。",
	...
	en: {
		app: {
			previewTag: "Spark 2.1",
			panelCopy: "CAMERA_FRAMES workflow built on Spark 2.1.",
		},
		field: {
			language: "Language",
		...
		workspace: {
			...
			resizeViews: "Resize camera views",
		},
		transformSpace: {
			world: "World",
			local: "Local",
		...
		timeline: {
			...
			keyTargetCamera: "Camera",
			keyTargetSelectedObjects: "Objects",
			keyTargetBoth: "Both",
			keyTargetNoObjects: "No objects",
			keyTargetObjects: "{count} Objects",
			targetTypeCamera: "CAM",
			targetTypeMesh: "MESH",
			targetTypeSplat: "SPLAT",
			addKey: "Add key",
			copyKeys: "Copy selected keys",
			pasteKeys: "Paste at current frame",
			deleteKeys: "Delete selected keys",
			currentFrameKeyed: "Keyed",
			currentFrameNoKey: "No key",
		...
		action: {
			...
			openFiles: "Open…",
			resetFrameTrajectoryNodeAuto: "Reset Node to Auto",
			...
			close: "Close",
			closeWorkspacePane: "Close {name}",
			showDualWorkspace: "Show Camera View and Viewport together",
			continueSave: "Save",
			continueLoad: "Load",
			showAsset: "Show",
			hideAsset: "Hide",
			...
			undo: "Undo",
			redo: "Redo",
			duplicateSelectedSceneAssets: "Duplicate Selected Objects",
			...
			splatEditOptimizeLod: "Optimize LoD",
		...
		overlay: {
			...
			importDetailLoadAssetStage: "Asset {index}/{count}: {name} - {stage}",
			importTimingStage: "stage",
			importTimingTotal: "total",
			importLoadStage: {
				materialize: "Expanding package resource",
				readBytes: "Reading file bytes",
				decodeSource: "Converting 3DGS data",
				prepareRawPackedSplat: "Preparing raw 3DGS arrays / LoD arrays",
				initLod: "Initializing baked LoD",
				initPackedSplats: "Initializing Spark PackedSplats",
				buildBounds: "Computing bounds",
				initSplatMesh: "Preparing GPU mesh",
				registerScene: "Registering scene asset",
				loadModel: "Loading 3D model",
			},
		...
		status: {
			...
			dualWorkspaceEnabled: "Showing Camera View and Viewport together.",
			workspacePaneClosed: "Closed {name}.",
			...
			splatEditDuplicate: "Duplicate",
			splatEditSelectAll: "Select All",
			splatEditInvert: "Invert",
			splatEditLodStale: "Optimize LoD",
			splatEditLodReady: "LoD ready",
			splatEditLodRunning: "Building LoD…",
			splatEditLodTooltip:
				"Rebuild the rendering LoD. Splat edits invalidate it automatically, so press this to keep the scene lightweight.",
			...
			splatEditDuplicated: "Duplicated {count} splats into {assets} asset(s).",
			splatEditSelectAllDone: "Selected all {count} splats.",
			splatEditInverted: "Inverted selection ({count} splats).",
			...
			duplicatedSceneAsset: "Duplicated {name}.",
			duplicatedSceneAssets: "Duplicated {count} objects.",
