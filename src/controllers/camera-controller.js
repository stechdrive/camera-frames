...
export function createCameraController({
	...
	return {
		...
		setShotCameraLensShiftAxis: lensClipping.setShotCameraLensShiftAxis,
		setShotCameraLensShiftXPercent: lensClipping.setShotCameraLensShiftXPercent,
		setShotCameraLensShiftYPercent: lensClipping.setShotCameraLensShiftYPercent,
